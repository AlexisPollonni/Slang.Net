...
public unsafe partial struct IByteCodeRunner
{
    ...
    public partial struct Vtbl
    {
        ...
        [NativeTypeName("SlangResult (uint32_t, ByteCodeFuncInfo *) __attribute__((nothrow)) __attribute__((stdcall))")]
        public IntPtr getFunctionInfo;

        [NativeTypeName("void *() __attribute__((nothrow)) __attribute__((stdcall))")]
        public IntPtr getCurrentWorkingSet;

        [NativeTypeName("SlangResult (void *, size_t) __attribute__((nothrow)) __attribute__((stdcall))")]
        ...
        [NativeTypeName("SlangResult (const char *, VMExtFunction) __attribute__((nothrow)) __attribute__((stdcall))")]
        public IntPtr registerExtCall;

        [NativeTypeName("SlangResult (VMPrintFunc, void *) __attribute__((nothrow)) __attribute__((stdcall))")]
