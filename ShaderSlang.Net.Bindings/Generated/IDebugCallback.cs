...
public unsafe partial struct IDebugCallback
{
    ...
    public void handleMessage([NativeTypeName("gfx::DebugMessageType")] DebugMessageType type, [NativeTypeName("gfx::DebugMessageSource")] DebugMessageSource source, [NativeTypeName("const char *")] sbyte* message)
    {
        Marshal.GetDelegateForFunctionPointer<_handleMessage>(lpVtbl->handleMessage)((IDebugCallback*)Unsafe.AsPointer(ref this), type, source, message);
    }

    public partial struct Vtbl
    {
        [NativeTypeName("void (DebugMessageType, DebugMessageSource, const char *) __attribute__((stdcall))")]
