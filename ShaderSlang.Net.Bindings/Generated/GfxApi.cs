...
public static unsafe partial class GfxApi
{
    ...
    public static extern Boolean gfxIsCompressedFormat(
    ...
    public static extern int gfxGetFormatInfo(
        [NativeTypeName("gfx::Format")] Format format,
        [NativeTypeName("gfx::FormatInfo *")] FormatInfo* outInfo
    );

    /// <include file='GfxApi.xml' path='doc/member[@name="GfxApi.gfxGetAdapters"]/*' />
    [DllImport("gfx", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
    [return: NativeTypeName("SlangResult")]
    public static extern int gfxGetAdapters(
        [NativeTypeName("gfx::DeviceType")] DeviceType type,
    ...
    [DllImport("gfx", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
    [return: NativeTypeName("SlangResult")]
    public static extern int gfxCreateDevice(
        [NativeTypeName("const IDevice::Desc *")] DeviceDesc* desc,
        IDevice** outDevice
    );
    ...
    [DllImport("gfx", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
    [return: NativeTypeName("SlangResult")]
    public static extern int gfxSetDebugCallback(
        [NativeTypeName("gfx::IDebugCallback *")] IDebugCallback* callback
    );
    ...
    public static extern sbyte* gfxGetDeviceTypeName(
        [NativeTypeName("gfx::DeviceType")] DeviceType type
    );

    public static readonly Guid IID_ICommandEncoder = new Guid(
        0x77EA6383,
        0xBE3D,
        0x40AA,
        0x8B,
    ...
    public static readonly Guid IID_IResourceCommandEncoder = new Guid(
        0xF99A00E9,
        0xED50,
        0x4088,
        0x8A,
    ...
    public static readonly Guid IID_IRenderCommandEncoder = new Guid(
        0x7A8D56D0,
        0x53E6,
        0x4AD6,
        0x85,
    ...
    public static readonly Guid IID_IComputeCommandEncoder = new Guid(
        0x88AA9322,
        0x82F7,
        0x4FE6,
        0xA6,
    ...
    public static readonly Guid IID_IRayTracingCommandEncoder = new Guid(
        0x9A672B87,
        0x5035,
        0x45E3,
        0x96,
