...
public enum ResourceState
{
    ...
    /// <include file='ResourceState.xml' path='doc/member[@name="ResourceState.PreInitialized"]/*' />
    PreInitialized,
    ...
    /// <include file='ResourceState.xml' path='doc/member[@name="ResourceState.PixelShaderResource"]/*' />
    PixelShaderResource,

    /// <include file='ResourceState.xml' path='doc/member[@name="ResourceState.NonPixelShaderResource"]/*' />
    NonPixelShaderResource,

    /// <include file='ResourceState.xml' path='doc/member[@name="ResourceState._Count"]/*' />
    _Count,
}
