...
public unsafe partial struct IRenderCommandEncoder
{
    ...
    public partial struct Vtbl
    {
        ...
        [NativeTypeName("void (GfxIndex, GfxCount, IBufferResource *const *, const Offset *) __attribute__((stdcall))")]
        ...
        [NativeTypeName("Result (GfxCount, IBufferResource *, Offset, IBufferResource *, Offset) __attribute__((stdcall))")]
        ...
        [NativeTypeName("Result (GfxCount, GfxCount, const SamplePosition *) __attribute__((stdcall))")]
        ...
        [NativeTypeName("Result (GfxCount, GfxCount, GfxIndex, GfxIndex, GfxIndex) __attribute__((stdcall))")]
