...
public unsafe partial struct IRenderCommandEncoder
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void _setViewports(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::GfxCount")] int count,
        [NativeTypeName("const Viewport *")] Viewport* viewports
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void _setScissorRects(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::GfxCount")] int count,
        [NativeTypeName("const ScissorRect *")] ScissorRect* scissors
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void _setPrimitiveTopology(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::PrimitiveTopology")] PrimitiveTopology topology
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void _setVertexBuffers(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::GfxIndex")] int startSlot,
        [NativeTypeName("gfx::GfxCount")] int slotCount,
        [NativeTypeName("IBufferResource *const *")] IBufferResource** buffers,
        [NativeTypeName("const Offset *")] nuint* offsets
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void _setIndexBuffer(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::IBufferResource *")] IBufferResource* buffer,
        [NativeTypeName("gfx::Format")] Format indexFormat,
        [NativeTypeName("gfx::Offset")] nuint offset = 0
    );
    ...
    public delegate int _draw(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::GfxCount")] int vertexCount,
        [NativeTypeName("gfx::GfxIndex")] int startVertex = 0
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("gfx::Result")]
    public delegate int _drawIndexed(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::GfxCount")] int indexCount,
        [NativeTypeName("gfx::GfxIndex")] int startIndex = 0,
        [NativeTypeName("gfx::GfxIndex")] int baseVertex = 0
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("gfx::Result")]
    public delegate int _drawIndirect(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::GfxCount")] int maxDrawCount,
        [NativeTypeName("gfx::IBufferResource *")] IBufferResource* argBuffer,
        [NativeTypeName("gfx::Offset")] nuint argOffset,
        [NativeTypeName("gfx::IBufferResource *")] IBufferResource* countBuffer = null,
        [NativeTypeName("gfx::Offset")] nuint countOffset = 0
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("gfx::Result")]
    public delegate int _drawIndexedIndirect(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::GfxCount")] int maxDrawCount,
        [NativeTypeName("gfx::IBufferResource *")] IBufferResource* argBuffer,
        [NativeTypeName("gfx::Offset")] nuint argOffset,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void _setStencilReference(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("uint32_t")] uint referenceValue
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("gfx::Result")]
    public delegate int _setSamplePositions(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::GfxCount")] int samplesPerPixel,
        [NativeTypeName("gfx::GfxCount")] int pixelCount,
        [NativeTypeName("const SamplePosition *")] SamplePosition* samplePositions
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("gfx::Result")]
    public delegate int _drawInstanced(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::GfxCount")] int vertexCount,
        [NativeTypeName("gfx::GfxCount")] int instanceCount,
        [NativeTypeName("gfx::GfxIndex")] int startVertex,
        [NativeTypeName("gfx::GfxIndex")] int startInstanceLocation
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("gfx::Result")]
    public delegate int _drawIndexedInstanced(
        IRenderCommandEncoder* pThis,
        [NativeTypeName("gfx::GfxCount")] int indexCount,
        [NativeTypeName("gfx::GfxCount")] int instanceCount,
        [NativeTypeName("gfx::GfxIndex")] int startIndexLocation,
        [NativeTypeName("gfx::GfxIndex")] int baseVertexLocation,
        [NativeTypeName("gfx::GfxIndex")] int startInstanceLocation
    );
    ...
    )
    {
        return Marshal.GetDelegateForFunctionPointer<_queryInterface>(lpVtbl->queryInterface)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            uuid,
            outObject
        );
    }
    ...
    )
    {
        ...
        )((IRenderCommandEncoder*)Unsafe.AsPointer(ref this), texture, subresourceRange, src, dst);
    }
    ...
    )
    {
        ...
        )((IRenderCommandEncoder*)Unsafe.AsPointer(ref this), state, rootObject);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_setViewports>(lpVtbl->setViewports)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            count,
            viewports
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void setScissorRects(
        [NativeTypeName("gfx::GfxCount")] int count,
        [NativeTypeName("const ScissorRect *")] ScissorRect* scissors
    )
    {
        Marshal.GetDelegateForFunctionPointer<_setScissorRects>(lpVtbl->setScissorRects)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            count,
            scissors
        );
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_setPrimitiveTopology>(lpVtbl->setPrimitiveTopology)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            topology
        );
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_setVertexBuffers>(lpVtbl->setVertexBuffers)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            startSlot,
            slotCount,
            buffers,
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_setIndexBuffer>(lpVtbl->setIndexBuffer)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            buffer,
            indexFormat,
            offset
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_drawIndexed>(lpVtbl->drawIndexed)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            indexCount,
            startIndex,
            baseVertex
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_drawIndirect>(lpVtbl->drawIndirect)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            maxDrawCount,
            argBuffer,
            argOffset,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("gfx::Result")]
    public int drawIndexedIndirect(
        [NativeTypeName("gfx::GfxCount")] int maxDrawCount,
        [NativeTypeName("gfx::IBufferResource *")] IBufferResource* argBuffer,
        [NativeTypeName("gfx::Offset")] nuint argOffset,
        [NativeTypeName("gfx::IBufferResource *")] IBufferResource* countBuffer = null,
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_drawIndexedIndirect>(
            lpVtbl->drawIndexedIndirect
        )(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            maxDrawCount,
            argBuffer,
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_setStencilReference>(lpVtbl->setStencilReference)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            referenceValue
        );
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("gfx::Result")]
    public int setSamplePositions(
        [NativeTypeName("gfx::GfxCount")] int samplesPerPixel,
        [NativeTypeName("gfx::GfxCount")] int pixelCount,
        [NativeTypeName("const SamplePosition *")] SamplePosition* samplePositions
    )
    {
        return Marshal.GetDelegateForFunctionPointer<_setSamplePositions>(
            lpVtbl->setSamplePositions
        )(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            samplesPerPixel,
            pixelCount,
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_drawInstanced>(lpVtbl->drawInstanced)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            vertexCount,
            instanceCount,
            startVertex,
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_drawIndexedInstanced>(
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_drawMeshTasks>(lpVtbl->drawMeshTasks)(
            (IRenderCommandEncoder*)Unsafe.AsPointer(ref this),
            x,
            y,
            z
    ...
    public partial struct Vtbl
    {
        ...
        [NativeTypeName(
            "void (IBufferResource *, Offset, IBufferResource *, Offset, Size) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr copyBuffer;

        [NativeTypeName(
            "void (ITextureResource *, ResourceState, SubresourceRange, ITextureResource::Offset3D, ITextureResource *, ResourceState, SubresourceRange, ITextureResource::Offset3D, ITextureResource::Extents) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr copyTexture;

        [NativeTypeName(
            "void (IBufferResource *, Offset, Size, Size, ITextureResource *, ResourceState, SubresourceRange, ITextureResource::Offset3D, ITextureResource::Extents) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr copyTextureToBuffer;

        [NativeTypeName(
            "void (ITextureResource *, SubresourceRange, ITextureResource::Offset3D, ITextureResource::Extents, ITextureResource::SubresourceData *, GfxCount) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr uploadTextureData;

        [NativeTypeName(
            "void (IBufferResource *, Offset, Size, void *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr uploadBufferData;

        [NativeTypeName(
            "void (GfxCount, ITextureResource *const *, ResourceState, ResourceState) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr textureBarrier;

        [NativeTypeName(
            "void (ITextureResource *, SubresourceRange, ResourceState, ResourceState) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr textureSubresourceBarrier;

        [NativeTypeName(
            "void (GfxCount, IBufferResource *const *, ResourceState, ResourceState) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr bufferBarrier;

        [NativeTypeName(
            "void (IResourceView *, ClearValue *, ClearResourceViewFlags::Enum) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr clearResourceView;

        [NativeTypeName(
            "void (ITextureResource *, ResourceState, SubresourceRange, ITextureResource *, ResourceState, SubresourceRange) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr resolveResource;

        [NativeTypeName(
            "void (IQueryPool *, GfxIndex, GfxCount, IBufferResource *, Offset) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr resolveQuery;

        [NativeTypeName(
            "void (const char *, float *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "Result (IPipelineState *, IShaderObject **) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "void (GfxCount, const Viewport *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr setViewports;

        [NativeTypeName(
            "void (GfxCount, const ScissorRect *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr setScissorRects;

        [NativeTypeName(
            "void (PrimitiveTopology) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr setPrimitiveTopology;

        [NativeTypeName(
            "void (GfxIndex, GfxCount, IBufferResource *const *, const Offset *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr setVertexBuffers;

        [NativeTypeName(
            "void (IBufferResource *, Format, Offset) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr setIndexBuffer;

        [NativeTypeName(
            "Result (GfxCount, GfxIndex) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr draw;

        [NativeTypeName(
            "Result (GfxCount, GfxIndex, GfxIndex) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr drawIndexed;

        [NativeTypeName(
            "Result (GfxCount, IBufferResource *, Offset, IBufferResource *, Offset) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName("void (uint32_t) __attribute__((nothrow)) __attribute__((stdcall))")]
        public IntPtr setStencilReference;

        [NativeTypeName(
            "Result (GfxCount, GfxCount, const SamplePosition *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr setSamplePositions;

        [NativeTypeName(
            "Result (GfxCount, GfxCount, GfxIndex, GfxIndex) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr drawInstanced;

        [NativeTypeName(
            "Result (GfxCount, GfxCount, GfxIndex, GfxIndex, GfxIndex) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
