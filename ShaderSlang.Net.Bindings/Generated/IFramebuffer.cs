...
public unsafe partial struct IFramebuffer
{
    ...
    public delegate int _queryInterface(IFramebuffer* pThis, [NativeTypeName("const SlangUUID &")] SlangUUID* uuid, void** outObject);
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_queryInterface>(lpVtbl->queryInterface)((IFramebuffer*)Unsafe.AsPointer(ref this), uuid, outObject);
    }
    ...
    public uint addRef()
    {
        return Marshal.GetDelegateForFunctionPointer<_addRef>(lpVtbl->addRef)((IFramebuffer*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint release()
    {
        return Marshal.GetDelegateForFunctionPointer<_release>(lpVtbl->release)((IFramebuffer*)Unsafe.AsPointer(ref this));
    }
