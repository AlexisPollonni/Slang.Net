...
public unsafe partial struct IGlobalSession
{
    ...
    public partial struct Vtbl
    {
        ...
        [NativeTypeName("SlangResult (SlangSourceLanguage, SlangPassThrough) __attribute__((stdcall))")]
        ...
        [NativeTypeName("void (SlangCompileTarget, SlangCompileTarget, SlangPassThrough) __attribute__((stdcall))")]
        public IntPtr setDownstreamCompilerForTransition;

        [NativeTypeName("SlangPassThrough (SlangCompileTarget, SlangCompileTarget) __attribute__((stdcall))")]
        ...
        [NativeTypeName("SlangResult (int, const char *const *, SessionDesc *, ISlangUnknown **) __attribute__((stdcall))")]
        ...
        [NativeTypeName("SlangResult (BuiltinModuleName, CompileCoreModuleFlags) __attribute__((stdcall))")]
        public IntPtr compileBuiltinModule;

        [NativeTypeName("SlangResult (BuiltinModuleName, const void *, size_t) __attribute__((stdcall))")]
        public IntPtr loadBuiltinModule;

        [NativeTypeName("SlangResult (BuiltinModuleName, SlangArchiveType, ISlangBlob **) __attribute__((stdcall))")]
