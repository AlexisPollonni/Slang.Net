...
public unsafe partial struct ICompileRequest
{
    ...
    public partial struct Vtbl
    {
        ...
        [NativeTypeName("void (int, const char *, const char *, const char *) __attribute__((stdcall))")]
        ...
        [NativeTypeName("int (int, const char *, SlangStage, int, const char **) __attribute__((stdcall))")]
        ...
        [NativeTypeName("SlangResult (ISlangFileSystem *, const void *, size_t) __attribute__((stdcall))")]
        ...
        [NativeTypeName("SlangResult (SlangInt, slang::IComponentType **) __attribute__((stdcall))")]
        ...
        [NativeTypeName("SlangResult (SlangInt, SlangInt, SlangParameterCategory, SlangUInt, SlangUInt, bool &) __attribute__((stdcall))")]
