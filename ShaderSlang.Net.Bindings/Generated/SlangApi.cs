...
public static unsafe partial class SlangApi
{
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int ReflectionVariable_GetDefaultValueInt(SlangReflectionVariable* inVar, [NativeTypeName("int64_t *")] nint* rs);
    ...
    public static extern nint ReflectionGeneric_GetConcreteIntVal(SlangReflectionGeneric* generic, SlangReflectionVariable* valueParam);
    ...
    [DllImport("slang", CallingConvention = CallingConvention.Cdecl, EntryPoint = "_Z23spReflection_GetSessionP18SlangProgramLayout", ExactSpelling = true)]
    ...
    [DllImport("slang", CallingConvention = CallingConvention.Cdecl, EntryPoint = "_Z27slang_getEmbeddedCoreModulev", ExactSpelling = true)]
    ...
    public static readonly Guid IID_ICompileResult = new Guid(0x5FA9380E, 0xB62F, 0x41E5, 0x9F, 0x12, 0x4B, 0xAD, 0x4D, 0x9E, 0xAA, 0xE4);
    ...
    public static readonly Guid IID_IComponentType2 = new Guid(0x9C2A4B3D, 0x7F68, 0x4E91, 0xA5, 0x2C, 0x8B, 0x19, 0x3E, 0x45, 0x7A, 0x9F);
