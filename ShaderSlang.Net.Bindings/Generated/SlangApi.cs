...
public static unsafe partial class SlangApi
{
    ...
    [DllImport(
        ...
        EntryPoint = "spGetBuildTagString",
        ExactSpelling = true
    )]
    ...
    public const int SLANG_FAIL = unchecked(
        (((int)(0)) << 16) | ((int)(0x4005)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_NOT_IMPLEMENTED SLANG_MAKE_WIN_GENERAL_ERROR(0x4001)")]
    public const int SLANG_E_NOT_IMPLEMENTED = unchecked(
        (((int)(0)) << 16) | ((int)(0x4001)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_NO_INTERFACE SLANG_MAKE_WIN_GENERAL_ERROR(0x4002)")]
    public const int SLANG_E_NO_INTERFACE = unchecked(
        (((int)(0)) << 16) | ((int)(0x4002)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_ABORT SLANG_MAKE_WIN_GENERAL_ERROR(0x4004)")]
    public const int SLANG_E_ABORT = unchecked(
        (((int)(0)) << 16) | ((int)(0x4004)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_INVALID_HANDLE SLANG_MAKE_ERROR(SLANG_FACILITY_WIN_API, 6)")]
    public const int SLANG_E_INVALID_HANDLE = unchecked(
        (((int)(7)) << 16) | ((int)(6)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_INVALID_ARG SLANG_MAKE_ERROR(SLANG_FACILITY_WIN_API, 0x57)")]
    public const int SLANG_E_INVALID_ARG = unchecked(
        (((int)(7)) << 16) | ((int)(0x57)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_OUT_OF_MEMORY SLANG_MAKE_ERROR(SLANG_FACILITY_WIN_API, 0xe)")]
    public const int SLANG_E_OUT_OF_MEMORY = unchecked(
        (((int)(7)) << 16) | ((int)(0xe)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_BUFFER_TOO_SMALL SLANG_MAKE_CORE_ERROR(1)")]
    public const int SLANG_E_BUFFER_TOO_SMALL = unchecked(
        (((int)(0x200)) << 16) | ((int)(1)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_UNINITIALIZED SLANG_MAKE_CORE_ERROR(2)")]
    public const int SLANG_E_UNINITIALIZED = unchecked(
        (((int)(0x200)) << 16) | ((int)(2)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_PENDING SLANG_MAKE_CORE_ERROR(3)")]
    public const int SLANG_E_PENDING = unchecked(
        (((int)(0x200)) << 16) | ((int)(3)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_CANNOT_OPEN SLANG_MAKE_CORE_ERROR(4)")]
    public const int SLANG_E_CANNOT_OPEN = unchecked(
        (((int)(0x200)) << 16) | ((int)(4)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_NOT_FOUND SLANG_MAKE_CORE_ERROR(5)")]
    public const int SLANG_E_NOT_FOUND = unchecked(
        (((int)(0x200)) << 16) | ((int)(5)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_INTERNAL_FAIL SLANG_MAKE_CORE_ERROR(6)")]
    public const int SLANG_E_INTERNAL_FAIL = unchecked(
        (((int)(0x200)) << 16) | ((int)(6)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_E_NOT_AVAILABLE SLANG_MAKE_CORE_ERROR(7)")]
    public const int SLANG_E_NOT_AVAILABLE = unchecked(
        (((int)(0x200)) << 16) | ((int)(7)) | (int)(0x80000000)
    );
    ...
    public const int SLANG_ERROR_INSUFFICIENT_BUFFER = unchecked(
        (((int)(0x200)) << 16) | ((int)(1)) | (int)(0x80000000)
    );

    [NativeTypeName("#define SLANG_ERROR_INVALID_PARAMETER SLANG_E_INVALID_ARG")]
    public const int SLANG_ERROR_INVALID_PARAMETER = unchecked(
        (((int)(7)) << 16) | ((int)(0x57)) | (int)(0x80000000)
    );
    ...
    public static extern IGlobalSession* CreateSession(
        [NativeTypeName("const char *")] sbyte* deprecated = null
    );
    ...
    public static extern void DestroySession(
        [NativeTypeName("SlangSession *")] IGlobalSession* session
    );
    ...
    public static extern void SessionSetSharedLibraryLoader(
        [NativeTypeName("SlangSession *")] IGlobalSession* session,
    ...
    public static extern ISlangSharedLibraryLoader* SessionGetSharedLibraryLoader(
        [NativeTypeName("SlangSession *")] IGlobalSession* session
    );
    ...
    public static extern int SessionCheckCompileTargetSupport(
        [NativeTypeName("SlangSession *")] IGlobalSession* session,
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int SessionCheckPassThroughSupport(
        [NativeTypeName("SlangSession *")] IGlobalSession* session,
    ...
    public static extern void AddBuiltins(
        [NativeTypeName("SlangSession *")] IGlobalSession* session,
    ...
    public static extern ICompileRequest* CreateCompileRequest(
        [NativeTypeName("SlangSession *")] IGlobalSession* session
    );
    ...
    public static extern void DestroyCompileRequest(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request
    );
    ...
    public static extern void SetCompileFlags(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangCompileFlags")] uint flags
    );
    ...
    public static extern uint GetCompileFlags(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request
    );
    ...
    public static extern void SetDumpIntermediates(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int enable
    );
    ...
    public static extern void SetDumpIntermediatePrefix(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
    ...
    public static extern void SetLineDirectiveMode(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangLineDirectiveMode")] LineDirectiveMode mode
    );
    ...
    public static extern void SetTargetLineDirectiveMode(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int targetIndex,
        [NativeTypeName("SlangLineDirectiveMode")] LineDirectiveMode mode
    );
    ...
    public static extern void SetTargetForceGLSLScalarBufferLayout(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int targetIndex,
        [NativeTypeName("bool")] Boolean forceScalarLayout
    );
    ...
    public static extern void SetTargetUseMinimumSlangOptimization(
        [NativeTypeName("slang::ICompileRequest *")] ICompileRequest* request,
        int targetIndex,
        [NativeTypeName("bool")] Boolean val
    );
    ...
    public static extern void SetIgnoreCapabilityCheck(
        [NativeTypeName("slang::ICompileRequest *")] ICompileRequest* request,
        [NativeTypeName("bool")] Boolean val
    );
    ...
    public static extern void SetCodeGenTarget(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangCompileTarget")] CompileTarget target
    );
    ...
    public static extern int AddCodeGenTarget(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangCompileTarget")] CompileTarget target
    );
    ...
    public static extern void SetTargetProfile(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int targetIndex,
        [NativeTypeName("SlangProfileID")] ProfileID profile
    );
    ...
    public static extern void SetTargetFlags(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int targetIndex,
        [NativeTypeName("SlangTargetFlags")] uint flags
    );
    ...
    public static extern void SetTargetFloatingPointMode(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int targetIndex,
        [NativeTypeName("SlangFloatingPointMode")] FloatingPointMode mode
    );
    ...
    public static extern void AddTargetCapability(
        [NativeTypeName("slang::ICompileRequest *")] ICompileRequest* request,
        int targetIndex,
        [NativeTypeName("SlangCapabilityID")] CapabilityID capability
    );
    ...
    public static extern void SetTargetMatrixLayoutMode(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int targetIndex,
        [NativeTypeName("SlangMatrixLayoutMode")] MatrixLayoutMode mode
    );
    ...
    public static extern void SetMatrixLayoutMode(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangMatrixLayoutMode")] MatrixLayoutMode mode
    );
    ...
    public static extern void SetDebugInfoLevel(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangDebugInfoLevel")] DebugInfoLevel level
    );
    ...
    public static extern void SetDebugInfoFormat(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangDebugInfoFormat")] DebugInfoFormat format
    );
    ...
    public static extern void SetOptimizationLevel(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangOptimizationLevel")] OptimizationLevel level
    );
    ...
    public static extern void SetOutputContainerFormat(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangContainerFormat")] ContainerFormat format
    );
    ...
    public static extern void SetPassThrough(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangPassThrough")] PassThrough passThrough
    );
    ...
    public static extern void SetDiagnosticCallback(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangDiagnosticCallback")] IntPtr callback,
        [NativeTypeName("const void *")] void* userData
    );
    ...
    public static extern void SetWriter(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangWriterChannel")] WriterChannel channel,
        ISlangWriter* writer
    );
    ...
    public static extern ISlangWriter* GetWriter(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangWriterChannel")] WriterChannel channel
    );
    ...
    public static extern void AddSearchPath(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("const char *")] sbyte* searchDir
    );
    ...
    public static extern void AddPreprocessorDefine(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("const char *")] sbyte* key,
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int ProcessCommandLineArguments(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
    ...
    public static extern int AddTranslationUnit(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangSourceLanguage")] SourceLanguage language,
    ...
    public static extern void SetDefaultModuleName(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("const char *")] sbyte* defaultModuleName
    );
    ...
    public static extern void TranslationUnit_addPreprocessorDefine(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
    ...
    public static extern void AddTranslationUnitSourceFile(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int translationUnitIndex,
    ...
    public static extern void AddTranslationUnitSourceString(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int translationUnitIndex,
        [NativeTypeName("const char *")] sbyte* path,
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int AddLibraryReference(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("const char *")] sbyte* basePath,
        [NativeTypeName("const void *")] void* libData,
        [NativeTypeName("size_t")] nuint libDataSize
    );
    ...
    public static extern void AddTranslationUnitSourceStringSpan(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int translationUnitIndex,
        [NativeTypeName("const char *")] sbyte* path,
        [NativeTypeName("const char *")] sbyte* sourceBegin,
        [NativeTypeName("const char *")] sbyte* sourceEnd
    );
    ...
    public static extern void AddTranslationUnitSourceBlob(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int translationUnitIndex,
        [NativeTypeName("const char *")] sbyte* path,
    ...
    public static extern ProfileID FindProfile(
        [NativeTypeName("SlangSession *")] IGlobalSession* session,
        [NativeTypeName("const char *")] sbyte* name
    );
    ...
    public static extern CapabilityID FindCapability(
        [NativeTypeName("SlangSession *")] IGlobalSession* session,
        [NativeTypeName("const char *")] sbyte* name
    );
    ...
    public static extern int AddEntryPoint(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int translationUnitIndex,
        [NativeTypeName("const char *")] sbyte* name,
    ...
    public static extern int AddEntryPointEx(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int translationUnitIndex,
        [NativeTypeName("const char *")] sbyte* name,
        [NativeTypeName("SlangStage")] Stage stage,
        int genericArgCount,
        [NativeTypeName("const char **")] sbyte** genericArgs
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int SetGlobalGenericArgs(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int genericArgCount,
        [NativeTypeName("const char **")] sbyte** genericArgs
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int SetTypeNameForGlobalExistentialTypeParam(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int slotIndex,
        [NativeTypeName("const char *")] sbyte* typeName
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int SetTypeNameForEntryPointExistentialTypeParam(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int entryPointIndex,
        int slotIndex,
        [NativeTypeName("const char *")] sbyte* typeName
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* GetDiagnosticOutput(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int GetDiagnosticOutputBlob(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        ISlangBlob** outBlob
    );
    ...
    public static extern int GetDependencyFileCount(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request
    );
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* GetDependencyFilePath(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int index
    );
    ...
    public static extern int GetTranslationUnitCount(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request
    );
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* GetEntryPointSource(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int entryPointIndex
    );
    ...
    public static extern void* GetEntryPointCode(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int entryPointIndex,
        [NativeTypeName("size_t *")] nuint* outSize
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int GetEntryPointCodeBlob(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int entryPointIndex,
        int targetIndex,
        ISlangBlob** outBlob
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int GetEntryPointHostCallable(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int entryPointIndex,
        int targetIndex,
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int GetTargetCodeBlob(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int targetIndex,
        ISlangBlob** outBlob
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int GetTargetHostCallable(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int targetIndex,
        ISlangSharedLibrary** outSharedLibrary
    );
    ...
    [return: NativeTypeName("const void *")]
    public static extern void* GetCompileRequestCode(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("size_t *")] nuint* outSize
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int GetContainerCode(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        ISlangBlob** outBlob
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int LoadRepro(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        ISlangFileSystem* fileSystem,
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int SaveRepro(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        ISlangBlob** outBlob
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int EnableReproCapture(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int GetCompileTimeProfile(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        ISlangProfiler** compileTimeProfile,
        [NativeTypeName("bool")] Boolean shouldClear
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int ExtractRepro(
        [NativeTypeName("SlangSession *")] IGlobalSession* session,
        [NativeTypeName("const void *")] void* reproData,
        [NativeTypeName("size_t")] nuint reproDataSize,
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int LoadReproAsFileSystem(
        [NativeTypeName("SlangSession *")] IGlobalSession* session,
        [NativeTypeName("const void *")] void* reproData,
        [NativeTypeName("size_t")] nuint reproDataSize,
    ...
    public static extern void OverrideDiagnosticSeverity(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangInt")] nint messageID,
        [NativeTypeName("SlangSeverity")] Severity overrideSeverity
    );
    ...
    public static extern int GetDiagnosticFlags(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request
    );
    ...
    public static extern void SetDiagnosticFlags(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangDiagnosticFlags")] int flags
    );
    ...
    public static extern SlangProgramLayout* GetReflection(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request
    );
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* ReflectionUserAttribute_GetName(
    ...
    public static extern uint ReflectionUserAttribute_GetArgumentCount(
        SlangReflectionUserAttribute* attrib
    );
    ...
    public static extern SlangReflectionType* ReflectionUserAttribute_GetArgumentType(
        SlangReflectionUserAttribute* attrib,
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int ReflectionUserAttribute_GetArgumentValueInt(
        SlangReflectionUserAttribute* attrib,
        [NativeTypeName("unsigned int")] uint index,
        int* rs
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int ReflectionUserAttribute_GetArgumentValueFloat(
        SlangReflectionUserAttribute* attrib,
        [NativeTypeName("unsigned int")] uint index,
        float* rs
    );
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* ReflectionUserAttribute_GetArgumentValueString(
        SlangReflectionUserAttribute* attrib,
        [NativeTypeName("unsigned int")] uint index,
        [NativeTypeName("size_t *")] nuint* outSize
    );
    ...
    public static extern SlangReflectionUserAttribute* ReflectionType_GetUserAttribute(
    ...
    public static extern SlangReflectionUserAttribute* ReflectionType_FindUserAttributeByName(
        SlangReflectionType* type,
        [NativeTypeName("const char *")] sbyte* name
    );
    ...
    public static extern SlangReflectionType* ReflectionType_applySpecializations(
        SlangReflectionType* type,
    ...
    public static extern SlangReflectionVariable* ReflectionType_GetFieldByIndex(
        SlangReflectionType* type,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    [return: NativeTypeName("size_t")]
    public static extern nuint ReflectionType_GetSpecializedElementCount(
        SlangReflectionType* type,
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection
    );
    ...
    public static extern SlangReflectionType* ReflectionType_GetElementType(
        SlangReflectionType* type
    );
    ...
    public static extern SlangReflectionType* ReflectionType_GetResourceResultType(
        SlangReflectionType* type
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int ReflectionType_GetFullName(
        SlangReflectionType* type,
    ...
    public static extern SlangReflectionGeneric* ReflectionType_GetGenericContainer(
        SlangReflectionType* type
    );
    ...
    public static extern SlangReflectionType* ReflectionTypeLayout_GetType(
    ...
    [return: NativeTypeName("size_t")]
    public static extern nuint ReflectionTypeLayout_GetSize(
        SlangReflectionTypeLayout* type,
        [NativeTypeName("SlangParameterCategory")] ParameterCategory category
    );
    ...
    [return: NativeTypeName("size_t")]
    public static extern nuint ReflectionTypeLayout_GetStride(
        SlangReflectionTypeLayout* type,
        [NativeTypeName("SlangParameterCategory")] ParameterCategory category
    );
    ...
    public static extern int ReflectionTypeLayout_getAlignment(
        SlangReflectionTypeLayout* type,
        [NativeTypeName("SlangParameterCategory")] ParameterCategory category
    );
    ...
    public static extern SlangReflectionVariableLayout* ReflectionTypeLayout_GetFieldByIndex(
        SlangReflectionTypeLayout* type,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    public static extern nint ReflectionTypeLayout_findFieldIndexByName(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("const char *")] sbyte* nameBegin,
        [NativeTypeName("const char *")] sbyte* nameEnd
    );
    ...
    public static extern SlangReflectionVariableLayout* ReflectionTypeLayout_GetExplicitCounter(
        SlangReflectionTypeLayout* typeLayout
    );
    ...
    [return: NativeTypeName("size_t")]
    public static extern nuint ReflectionTypeLayout_GetElementStride(
        SlangReflectionTypeLayout* type,
        [NativeTypeName("SlangParameterCategory")] ParameterCategory category
    );
    ...
    public static extern SlangReflectionTypeLayout* ReflectionTypeLayout_GetElementTypeLayout(
        SlangReflectionTypeLayout* type
    );
    ...
    public static extern SlangReflectionVariableLayout* ReflectionTypeLayout_GetElementVarLayout(
        SlangReflectionTypeLayout* type
    );
    ...
    public static extern SlangReflectionVariableLayout* ReflectionTypeLayout_getContainerVarLayout(
        SlangReflectionTypeLayout* type
    );
    ...
    public static extern ParameterCategory ReflectionTypeLayout_GetParameterCategory(
        SlangReflectionTypeLayout* type
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionTypeLayout_GetCategoryCount(
        SlangReflectionTypeLayout* type
    );
    ...
    [return: NativeTypeName("SlangParameterCategory")]
    public static extern ParameterCategory ReflectionTypeLayout_GetCategoryByIndex(
        SlangReflectionTypeLayout* type,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    public static extern MatrixLayoutMode ReflectionTypeLayout_GetMatrixLayoutMode(
        SlangReflectionTypeLayout* type
    );
    ...
    public static extern int ReflectionTypeLayout_getGenericParamIndex(
        SlangReflectionTypeLayout* type
    );
    ...
    public static extern SlangReflectionTypeLayout* ReflectionTypeLayout_getPendingDataTypeLayout(
        SlangReflectionTypeLayout* type
    );
    ...
    public static extern SlangReflectionVariableLayout* ReflectionTypeLayout_getSpecializedTypePendingDataVarLayout(
        SlangReflectionTypeLayout* type
    );
    ...
    public static extern SlangReflectionType* ReflectionType_getSpecializedTypeArgType(
        SlangReflectionType* type,
        [NativeTypeName("SlangInt")] nint index
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getBindingRangeCount(
        SlangReflectionTypeLayout* typeLayout
    );
    ...
    public static extern BindingType ReflectionTypeLayout_getBindingRangeType(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint index
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_isBindingRangeSpecializable(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint index
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getBindingRangeBindingCount(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint index
    );
    ...
    public static extern SlangReflectionTypeLayout* ReflectionTypeLayout_getBindingRangeLeafTypeLayout(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint index
    );
    ...
    public static extern SlangReflectionVariable* ReflectionTypeLayout_getBindingRangeLeafVariable(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint index
    );
    ...
    public static extern ImageFormat ReflectionTypeLayout_getBindingRangeImageFormat(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint index
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getFieldBindingRangeOffset(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint fieldIndex
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getExplicitCounterBindingRangeOffset(
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getBindingRangeDescriptorSetIndex(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint index
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getBindingRangeFirstDescriptorRangeIndex(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint index
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getBindingRangeDescriptorRangeCount(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint index
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getDescriptorSetCount(
        SlangReflectionTypeLayout* typeLayout
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getDescriptorSetSpaceOffset(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint setIndex
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getDescriptorSetDescriptorRangeCount(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint setIndex
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getDescriptorSetDescriptorRangeIndexOffset(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint setIndex,
        [NativeTypeName("SlangInt")] nint rangeIndex
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getDescriptorSetDescriptorRangeDescriptorCount(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint setIndex,
        [NativeTypeName("SlangInt")] nint rangeIndex
    );
    ...
    [return: NativeTypeName("SlangBindingType")]
    public static extern BindingType ReflectionTypeLayout_getDescriptorSetDescriptorRangeType(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint setIndex,
        [NativeTypeName("SlangInt")] nint rangeIndex
    );
    ...
    [return: NativeTypeName("SlangParameterCategory")]
    public static extern ParameterCategory ReflectionTypeLayout_getDescriptorSetDescriptorRangeCategory(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint setIndex,
        [NativeTypeName("SlangInt")] nint rangeIndex
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getSubObjectRangeCount(
        SlangReflectionTypeLayout* typeLayout
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getSubObjectRangeBindingRangeIndex(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint subObjectRangeIndex
    );
    ...
    [return: NativeTypeName("SlangInt")]
    public static extern nint ReflectionTypeLayout_getSubObjectRangeSpaceOffset(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint subObjectRangeIndex
    );
    ...
    public static extern SlangReflectionVariableLayout* ReflectionTypeLayout_getSubObjectRangeOffset(
        SlangReflectionTypeLayout* typeLayout,
        [NativeTypeName("SlangInt")] nint subObjectRangeIndex
    );
    ...
    public static extern SlangReflectionType* ReflectionVariable_GetType(
    ...
    public static extern SlangReflectionModifier* ReflectionVariable_FindModifier(
        SlangReflectionVariable* var,
        [NativeTypeName("SlangModifierID")] ModifierID modifierID
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionVariable_GetUserAttributeCount(
        SlangReflectionVariable* var
    );
    ...
    public static extern SlangReflectionUserAttribute* ReflectionVariable_GetUserAttribute(
        SlangReflectionVariable* var,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    public static extern SlangReflectionUserAttribute* ReflectionVariable_FindUserAttributeByName(
        SlangReflectionVariable* var,
        [NativeTypeName("SlangSession *")] IGlobalSession* globalSession,
        [NativeTypeName("const char *")] sbyte* name
    );
    ...
    public static extern SlangReflectionGeneric* ReflectionVariable_GetGenericContainer(
        SlangReflectionVariable* var
    );
    ...
    public static extern SlangReflectionVariable* ReflectionVariable_applySpecializations(
        SlangReflectionVariable* var,
        SlangReflectionGeneric* generic
    );
    ...
    public static extern SlangReflectionVariable* ReflectionVariableLayout_GetVariable(
    ...
    public static extern SlangReflectionTypeLayout* ReflectionVariableLayout_GetTypeLayout(
        SlangReflectionVariableLayout* var
    );
    ...
    [return: NativeTypeName("size_t")]
    public static extern nuint ReflectionVariableLayout_GetOffset(
        SlangReflectionVariableLayout* var,
        [NativeTypeName("SlangParameterCategory")] ParameterCategory category
    );
    ...
    [return: NativeTypeName("size_t")]
    public static extern nuint ReflectionVariableLayout_GetSpace(
        SlangReflectionVariableLayout* var,
        [NativeTypeName("SlangParameterCategory")] ParameterCategory category
    );
    ...
    [return: NativeTypeName("SlangImageFormat")]
    public static extern ImageFormat ReflectionVariableLayout_GetImageFormat(
        SlangReflectionVariableLayout* var
    );
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* ReflectionVariableLayout_GetSemanticName(
        SlangReflectionVariableLayout* var
    );
    ...
    [return: NativeTypeName("size_t")]
    public static extern nuint ReflectionVariableLayout_GetSemanticIndex(
        SlangReflectionVariableLayout* var
    );
    ...
    public static extern SlangReflectionDecl* ReflectionFunction_asDecl(
    ...
    public static extern SlangReflectionModifier* ReflectionFunction_FindModifier(
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionFunction_GetUserAttributeCount(
        SlangReflectionFunction* func
    );
    ...
    public static extern SlangReflectionUserAttribute* ReflectionFunction_GetUserAttribute(
        SlangReflectionFunction* func,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    public static extern SlangReflectionUserAttribute* ReflectionFunction_FindUserAttributeByName(
        SlangReflectionFunction* func,
        [NativeTypeName("SlangSession *")] IGlobalSession* globalSession,
        [NativeTypeName("const char *")] sbyte* name
    );
    ...
    public static extern SlangReflectionVariable* ReflectionFunction_GetParameter(
        SlangReflectionFunction* func,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    public static extern SlangReflectionType* ReflectionFunction_GetResultType(
        SlangReflectionFunction* func
    );
    ...
    public static extern SlangReflectionGeneric* ReflectionFunction_GetGenericContainer(
        SlangReflectionFunction* func
    );
    ...
    public static extern SlangReflectionFunction* ReflectionFunction_applySpecializations(
        SlangReflectionFunction* func,
        SlangReflectionGeneric* generic
    );
    ...
    public static extern SlangReflectionFunction* ReflectionFunction_specializeWithArgTypes(
        SlangReflectionFunction* func,
        [NativeTypeName("SlangInt")] nint argTypeCount,
        [NativeTypeName("SlangReflectionType *const *")] SlangReflectionType** argTypes
    );
    ...
    public static extern SlangReflectionFunction* ReflectionFunction_getOverload(
        SlangReflectionFunction* func,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    public static extern SlangReflectionDecl* ReflectionDecl_getChild(
    ...
    public static extern SlangReflectionFunction* ReflectionDecl_castToFunction(
    ...
    public static extern SlangReflectionVariable* ReflectionDecl_castToVariable(
        SlangReflectionDecl* decl
    );
    ...
    public static extern SlangReflectionGeneric* ReflectionDecl_castToGeneric(
        SlangReflectionDecl* decl
    );
    ...
    public static extern SlangReflectionModifier* ReflectionDecl_findModifier(
        SlangReflectionDecl* decl,
        [NativeTypeName("SlangModifierID")] ModifierID modifierID
    );
    ...
    public static extern SlangReflectionDecl* ReflectionGeneric_asDecl(
        SlangReflectionGeneric* generic
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionGeneric_GetTypeParameterCount(
        SlangReflectionGeneric* generic
    );
    ...
    public static extern SlangReflectionVariable* ReflectionGeneric_GetTypeParameter(
        SlangReflectionGeneric* generic,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionGeneric_GetValueParameterCount(
        SlangReflectionGeneric* generic
    );
    ...
    public static extern SlangReflectionVariable* ReflectionGeneric_GetValueParameter(
        SlangReflectionGeneric* generic,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionGeneric_GetTypeParameterConstraintCount(
        SlangReflectionGeneric* generic,
    ...
    public static extern SlangReflectionType* ReflectionGeneric_GetTypeParameterConstraintType(
        SlangReflectionGeneric* generic,
        SlangReflectionVariable* typeParam,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    public static extern SlangReflectionDecl* ReflectionGeneric_GetInnerDecl(
        SlangReflectionGeneric* generic
    );
    ...
    public static extern SlangReflectionGeneric* ReflectionGeneric_GetOuterGenericContainer(
        SlangReflectionGeneric* generic
    );
    ...
    public static extern SlangReflectionType* ReflectionGeneric_GetConcreteType(
        SlangReflectionGeneric* generic,
        SlangReflectionVariable* typeParam
    );
    ...
    public static extern SlangReflectionGeneric* ReflectionGeneric_applySpecializations(
    ...
    public static extern Stage ReflectionVariableLayout_getStage(
        SlangReflectionVariableLayout* var
    );
    ...
    public static extern SlangReflectionVariableLayout* ReflectionVariableLayout_getPendingDataLayout(
        SlangReflectionVariableLayout* var
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionParameter_GetBindingIndex(
        [NativeTypeName("SlangReflectionParameter *")] SlangReflectionVariableLayout* parameter
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionParameter_GetBindingSpace(
        [NativeTypeName("SlangReflectionParameter *")] SlangReflectionVariableLayout* parameter
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int IsParameterLocationUsed(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangInt")] nint entryPointIndex,
        [NativeTypeName("SlangInt")] nint targetIndex,
        [NativeTypeName("SlangParameterCategory")] ParameterCategory category,
        [NativeTypeName("SlangUInt")] nuint spaceIndex,
        [NativeTypeName("SlangUInt")] nuint registerIndex,
        [NativeTypeName("bool &")] Boolean* outUsed
    );
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* ReflectionEntryPoint_getName(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint
    );
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* ReflectionEntryPoint_getNameOverride(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint
    );
    ...
    public static extern SlangReflectionFunction* ReflectionEntryPoint_getFunction(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionEntryPoint_getParameterCount(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint
    );
    ...
    public static extern SlangReflectionVariableLayout* ReflectionEntryPoint_getParameterByIndex(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    [return: NativeTypeName("SlangStage")]
    public static extern Stage ReflectionEntryPoint_getStage(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint
    );
    ...
    public static extern void ReflectionEntryPoint_getComputeThreadGroupSize(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint,
        [NativeTypeName("SlangUInt")] nuint axisCount,
        [NativeTypeName("SlangUInt *")] nuint* outSizeAlongAxis
    );
    ...
    public static extern void ReflectionEntryPoint_getComputeWaveSize(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint,
        [NativeTypeName("SlangUInt *")] nuint* outWaveSize
    );
    ...
    public static extern int ReflectionEntryPoint_usesAnySampleRateInput(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint
    );
    ...
    public static extern SlangReflectionVariableLayout* ReflectionEntryPoint_getVarLayout(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint
    );
    ...
    public static extern SlangReflectionVariableLayout* ReflectionEntryPoint_getResultVarLayout(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint
    );
    ...
    public static extern int ReflectionEntryPoint_hasDefaultConstantBuffer(
        [NativeTypeName("SlangReflectionEntryPoint *")] SlangEntryPointLayout* entryPoint
    );
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* ReflectionTypeParameter_GetName(
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionTypeParameter_GetIndex(
        SlangReflectionTypeParameter* typeParam
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint ReflectionTypeParameter_GetConstraintCount(
        SlangReflectionTypeParameter* typeParam
    );
    ...
    public static extern SlangReflectionType* ReflectionTypeParameter_GetConstraintByIndex(
        SlangReflectionTypeParameter* typeParam,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int Reflection_ToJson(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        ISlangBlob** outBlob
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint Reflection_GetParameterCount(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection
    );
    ...
    public static extern SlangReflectionVariableLayout* Reflection_GetParameterByIndex(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    [return: NativeTypeName("unsigned int")]
    public static extern uint Reflection_GetTypeParameterCount(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection
    );
    ...
    public static extern SlangReflectionTypeParameter* Reflection_GetTypeParameterByIndex(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        [NativeTypeName("unsigned int")] uint index
    );
    ...
    public static extern SlangReflectionTypeParameter* Reflection_FindTypeParameter(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        [NativeTypeName("const char *")] sbyte* name
    );
    ...
    public static extern SlangReflectionType* Reflection_FindTypeByName(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        [NativeTypeName("const char *")] sbyte* name
    );
    ...
    public static extern SlangReflectionTypeLayout* Reflection_GetTypeLayout(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        SlangReflectionType* reflectionType,
        [NativeTypeName("SlangLayoutRules")] LayoutRules rules
    );
    ...
    public static extern SlangReflectionFunction* Reflection_FindFunctionByName(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        [NativeTypeName("const char *")] sbyte* name
    );
    ...
    public static extern SlangReflectionFunction* Reflection_FindFunctionByNameInType(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
    ...
    public static extern SlangReflectionVariable* Reflection_FindVarByNameInType(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        SlangReflectionType* reflType,
        [NativeTypeName("const char *")] sbyte* name
    );
    ...
    public static extern SlangReflectionFunction* Reflection_TryResolveOverloadedFunction(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        [NativeTypeName("uint32_t")] uint candidateCount,
    ...
    public static extern nuint Reflection_getEntryPointCount(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection
    );
    ...
    public static extern SlangEntryPointLayout* Reflection_getEntryPointByIndex(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        [NativeTypeName("SlangUInt")] nuint index
    );
    ...
    [return: NativeTypeName("SlangReflectionEntryPoint *")]
    public static extern SlangEntryPointLayout* Reflection_findEntryPointByName(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        [NativeTypeName("const char *")] sbyte* name
    );
    ...
    [return: NativeTypeName("SlangUInt")]
    public static extern nuint Reflection_getGlobalConstantBufferBinding(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection
    );
    ...
    [return: NativeTypeName("size_t")]
    public static extern nuint Reflection_getGlobalConstantBufferSize(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection
    );
    ...
    public static extern SlangReflectionType* Reflection_specializeType(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        SlangReflectionType* type,
        [NativeTypeName("SlangInt")] nint specializationArgCount,
        [NativeTypeName("SlangReflectionType *const *")] SlangReflectionType** specializationArgs,
    ...
    public static extern SlangReflectionGeneric* Reflection_specializeGeneric(
        ...
        SlangReflectionGeneric* generic,
        [NativeTypeName("SlangInt")] nint argCount,
        [NativeTypeName("const SlangReflectionGenericArgType *")]
            ReflectionGenericArgType* argTypes,
        [NativeTypeName("const SlangReflectionGenericArg *")] SlangReflectionGenericArg* args,
        ISlangBlob** outDiagnostics
    );
    ...
    [return: NativeTypeName("bool")]
    public static extern Boolean Reflection_isSubType(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
    ...
    [return: NativeTypeName("SlangUInt")]
    public static extern nuint Reflection_getHashedStringCount(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection
    );
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* Reflection_getHashedString(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection,
        [NativeTypeName("SlangUInt")] nuint index,
        [NativeTypeName("size_t *")] nuint* outCount
    );
    ...
    public static extern uint ComputeStringHash(
        [NativeTypeName("const char *")] sbyte* chars,
        [NativeTypeName("size_t")] nuint count
    );
    ...
    public static extern SlangReflectionTypeLayout* Reflection_getGlobalParamsTypeLayout(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection
    );
    ...
    public static extern SlangReflectionVariableLayout* Reflection_getGlobalParamsVarLayout(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection
    );
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* GetTranslationUnitSource(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        int translationUnitIndex
    );
    ...
    public static extern ISession* Reflection_GetSession(
        [NativeTypeName("SlangReflection *")] SlangProgramLayout* reflection
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int CompileRequest_getProgram(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("slang::IComponentType **")] IComponentType** outProgram
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int CompileRequest_getProgramWithEntryPoints(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("slang::IComponentType **")] IComponentType** outProgram
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int CompileRequest_getEntryPoint(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangInt")] nint entryPointIndex,
        [NativeTypeName("slang::IComponentType **")] IComponentType** outEntryPoint
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int CompileRequest_getModule(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
        [NativeTypeName("SlangInt")] nint translationUnitIndex,
        [NativeTypeName("slang::IModule **")] IModule** outModule
    );
    ...
    [return: NativeTypeName("SlangResult")]
    public static extern int CompileRequest_getSession(
        [NativeTypeName("SlangCompileRequest *")] ICompileRequest* request,
    ...
    public static extern ISlangBlob* slang_createBlob(
        [NativeTypeName("const void *")] void* data,
        [NativeTypeName("size_t")] nuint size
    );
    ...
    public static extern IModule* slang_loadModuleFromSource(
        [NativeTypeName("slang::ISession *")] ISession* session,
        [NativeTypeName("const char *")] sbyte* moduleName,
        [NativeTypeName("const char *")] sbyte* path,
        [NativeTypeName("const char *")] sbyte* source,
        [NativeTypeName("size_t")] nuint sourceSize,
    ...
    [DllImport("slang", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("slang::IModule *")]
    public static extern IModule* slang_loadModuleFromIRBlob(
        [NativeTypeName("slang::ISession *")] ISession* session,
        [NativeTypeName("const char *")] sbyte* moduleName,
        [NativeTypeName("const char *")] sbyte* path,
    ...
    [DllImport("slang", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("SlangResult")]
    public static extern int slang_loadModuleInfoFromIRBlob(
        [NativeTypeName("slang::ISession *")] ISession* session,
        [NativeTypeName("const void *")] void* source,
        [NativeTypeName("size_t")] nuint sourceSize,
        [NativeTypeName("SlangInt &")] nint* outModuleVersion,
        [NativeTypeName("const char *&")] sbyte** outModuleCompilerVersion,
        [NativeTypeName("const char *&")] sbyte** outModuleName
    );

    /// <include file='SlangApi.xml' path='doc/member[@name="SlangApi.slang_createGlobalSession"]/*' />
    [DllImport("slang", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("SlangResult")]
    public static extern int slang_createGlobalSession(
        [NativeTypeName("SlangInt")] nint apiVersion,
        [NativeTypeName("slang::IGlobalSession **")] IGlobalSession** outGlobalSession
    );

    /// <include file='SlangApi.xml' path='doc/member[@name="SlangApi.slang_createGlobalSession2"]/*' />
    [DllImport("slang", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("SlangResult")]
    public static extern int slang_createGlobalSession2(
        [NativeTypeName("const SlangGlobalSessionDesc *")] SlangGlobalSessionDesc* desc,
        [NativeTypeName("slang::IGlobalSession **")] IGlobalSession** outGlobalSession
    );
    ...
    [DllImport("slang", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("SlangResult")]
    public static extern int slang_createGlobalSessionWithoutCoreModule(
        [NativeTypeName("SlangInt")] nint apiVersion,
        [NativeTypeName("slang::IGlobalSession **")] IGlobalSession** outGlobalSession
    );
    ...
    [DllImport("slang", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("SlangResult")]
    public static extern int slang_createByteCodeRunner(
        [NativeTypeName("const slang::ByteCodeRunnerDesc *")] ByteCodeRunnerDesc* desc,
        [NativeTypeName("slang::IByteCodeRunner **")] IByteCodeRunner** outByteCodeRunner
    );

    /// <include file='SlangApi.xml' path='doc/member[@name="SlangApi.slang_disassembleByteCode"]/*' />
    [DllImport("slang", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    [return: NativeTypeName("SlangResult")]
    public static extern int slang_disassembleByteCode(
        [NativeTypeName("slang::IBlob *")] ISlangBlob* moduleBlob,
        [NativeTypeName("slang::IBlob **")] ISlangBlob** outDisassemblyBlob
    );

    public static readonly Guid IID_ISlangUnknown = new Guid(
        0x00000000,
        0x0000,
        0x0000,
        0xC0,
    ...
    public static readonly Guid IID_ISlangCastable = new Guid(
        0x87EDE0E1,
        0x4852,
        0x44B0,
        0x8B,
    ...
    public static readonly Guid IID_ISlangClonable = new Guid(
        0x1EC36168,
        0xE9F4,
        0x430D,
        0xBB,
    ...
    public static readonly Guid IID_ISlangBlob = new Guid(
        0x8BA5FB08,
        0x5195,
        0x40E2,
        0xAC,
    ...
    public static readonly Guid IID_SlangTerminatedChars = new Guid(
        0xBE0DB1A8,
        0x3594,
        0x4603,
        0xA7,
    ...
    public static readonly Guid IID_ISlangFileSystem = new Guid(
        0x003A09FC,
        0x3A4D,
        0x4BA0,
        0xAD,
    ...
    public static readonly Guid IID_ISlangSharedLibrary_Dep1 = new Guid(
        0x9C9D5BC5,
        0xEB61,
        0x496F,
        0x80,
    ...
    public static readonly Guid IID_ISlangSharedLibrary = new Guid(
        0x70DBC7C4,
        0xDC3B,
        0x4A07,
        0xAE,
    ...
    public static readonly Guid IID_ISlangSharedLibraryLoader = new Guid(
        0x6264AB2B,
        0xA3E8,
        0x4A06,
        0x97,
    ...
    public static readonly Guid IID_ISlangFileSystemExt = new Guid(
        0x5FB632D2,
        0x979D,
        0x4481,
        0x9F,
    ...
    public static readonly Guid IID_ISlangMutableFileSystem = new Guid(
        0xA058675C,
        0x1D65,
        0x452A,
        0x84,
    ...
    public static readonly Guid IID_ISlangWriter = new Guid(
        0xEC457F0E,
        0x9ADD,
        0x4E6B,
        0x85,
    ...
    public static readonly Guid IID_ISlangProfiler = new Guid(
        0x197772C7,
        0x0155,
        0x4B91,
        0x84,
    ...
    public static readonly Guid IID_ICompileRequest = new Guid(
        0x96D33993,
        0x317C,
        0x4DB5,
        0xAF,
    ...
    public static readonly Guid IID_IGlobalSession = new Guid(
        0xC140B5FD,
        0x0C78,
        0x452E,
        0xBA,
    ...
    public static readonly Guid IID_ISession = new Guid(
        0x67618701,
        0xD116,
        0x468F,
        0xAB,
    ...
    public static readonly Guid IID_IMetadata = new Guid(
        0x8044A8A3,
        0xDDC0,
        0x4B7F,
        0xAF,
    ...
    public static readonly Guid IID_ICompileResult = new Guid(
        0x5FA9380E,
        0xB62F,
        0x41E5,
        0x9F,
    ...
    public static readonly Guid IID_IComponentType = new Guid(
        0x5BC42BE8,
        0x5C50,
        0x4929,
        0x9E,
    ...
    public static readonly Guid IID_IEntryPoint = new Guid(
        0x8F241361,
        0xF5BD,
        0x4CA0,
        0xA3,
    ...
    public static readonly Guid IID_ITypeConformance = new Guid(
        0x73EB3147,
        0xE544,
        0x41B5,
        0xB8,
    ...
    public static readonly Guid IID_IComponentType2 = new Guid(
        0x9C2A4B3D,
        0x7F68,
        0x4E91,
        0xA5,
    ...
    public static readonly Guid IID_IModule = new Guid(
        0x0C720E64,
        0x8722,
        0x4D31,
        0x89,
    ...
    public static readonly Guid IID_IModulePrecompileService_Experimental = new Guid(
        0x8E12E8E3,
        0x5FCD,
        0x433E,
        0xAF,
    ...
    public static readonly Guid IID_IByteCodeRunner = new Guid(
        0xAFDAB195,
        0x361F,
        0x42CB,
        0x95,
