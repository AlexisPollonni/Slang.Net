...
public unsafe partial struct IRayTracingCommandEncoder
{
    ...
    public partial struct Vtbl
    {
        ...
        [NativeTypeName(
            "void (const IAccelerationStructure::BuildDesc &, GfxCount, AccelerationStructureQueryDesc *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr buildAccelerationStructure;

        [NativeTypeName(
            "void (IAccelerationStructure *, IAccelerationStructure *, AccelerationStructureCopyMode) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr copyAccelerationStructure;

        [NativeTypeName(
            "void (GfxCount, IAccelerationStructure *const *, GfxCount, AccelerationStructureQueryDesc *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr queryAccelerationStructureProperties;

        [NativeTypeName(
            "void (DeviceAddress, IAccelerationStructure *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public IntPtr serializeAccelerationStructure;

        [NativeTypeName(
            "void (IAccelerationStructure *, DeviceAddress) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "Result (GfxIndex, IShaderTable *, GfxCount, GfxCount, GfxCount) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
