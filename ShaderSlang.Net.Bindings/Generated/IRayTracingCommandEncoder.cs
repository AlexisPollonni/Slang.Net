...
public unsafe partial struct IRayTracingCommandEncoder
{
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_queryInterface>(lpVtbl->queryInterface)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), uuid, outObject);
    }
    ...
    public uint addRef()
    {
        return Marshal.GetDelegateForFunctionPointer<_addRef>(lpVtbl->addRef)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint release()
    {
        return Marshal.GetDelegateForFunctionPointer<_release>(lpVtbl->release)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_endEncoding>(lpVtbl->endEncoding)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_writeTimestamp>(lpVtbl->writeTimestamp)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), queryPool, queryIndex);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_copyBuffer>(lpVtbl->copyBuffer)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), dst, dstOffset, src, srcOffset, size);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_copyTexture>(lpVtbl->copyTexture)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), dst, dstState, dstSubresource, dstOffset, src, srcState, srcSubresource, srcOffset, extent);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_copyTextureToBuffer>(lpVtbl->copyTextureToBuffer)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), dst, dstOffset, dstSize, dstRowStride, src, srcState, srcSubresource, srcOffset, extent);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_uploadTextureData>(lpVtbl->uploadTextureData)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), dst, subResourceRange, offset, extent, subResourceData, subResourceDataCount);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_uploadBufferData>(lpVtbl->uploadBufferData)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), dst, offset, size, data);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_textureBarrier>(lpVtbl->textureBarrier)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), count, textures, src, dst);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_textureSubresourceBarrier>(lpVtbl->textureSubresourceBarrier)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), texture, subresourceRange, src, dst);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_bufferBarrier>(lpVtbl->bufferBarrier)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), count, buffers, src, dst);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_clearResourceView>(lpVtbl->clearResourceView)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), view, clearValue, flags);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_resolveResource>(lpVtbl->resolveResource)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), source, sourceState, sourceRange, dest, destState, destRange);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_resolveQuery>(lpVtbl->resolveQuery)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), queryPool, index, count, buffer, offset);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_beginDebugEvent>(lpVtbl->beginDebugEvent)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), name, rgbColor);
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_endDebugEvent>(lpVtbl->endDebugEvent)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this));
    }

    /// <include file='IRayTracingCommandEncoder.xml' path='doc/member[@name="IRayTracingCommandEncoder.buildAccelerationStructure"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void buildAccelerationStructure([NativeTypeName("const IAccelerationStructure::BuildDesc &")] BuildDesc* desc, [NativeTypeName("gfx::GfxCount")] int propertyQueryCount, [NativeTypeName("gfx::AccelerationStructureQueryDesc *")] AccelerationStructureQueryDesc* queryDescs)
    {
        Marshal.GetDelegateForFunctionPointer<_buildAccelerationStructure>(lpVtbl->buildAccelerationStructure)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), desc, propertyQueryCount, queryDescs);
    }

    /// <include file='IRayTracingCommandEncoder.xml' path='doc/member[@name="IRayTracingCommandEncoder.copyAccelerationStructure"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void copyAccelerationStructure([NativeTypeName("gfx::IAccelerationStructure *")] IAccelerationStructure* dest, [NativeTypeName("gfx::IAccelerationStructure *")] IAccelerationStructure* src, [NativeTypeName("gfx::AccelerationStructureCopyMode")] AccelerationStructureCopyMode mode)
    {
        Marshal.GetDelegateForFunctionPointer<_copyAccelerationStructure>(lpVtbl->copyAccelerationStructure)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), dest, src, mode);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void queryAccelerationStructureProperties([NativeTypeName("gfx::GfxCount")] int accelerationStructureCount, [NativeTypeName("IAccelerationStructure *const *")] IAccelerationStructure** accelerationStructures, [NativeTypeName("gfx::GfxCount")] int queryCount, [NativeTypeName("gfx::AccelerationStructureQueryDesc *")] AccelerationStructureQueryDesc* queryDescs)
    {
        Marshal.GetDelegateForFunctionPointer<_queryAccelerationStructureProperties>(lpVtbl->queryAccelerationStructureProperties)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), accelerationStructureCount, accelerationStructures, queryCount, queryDescs);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("gfx::Result")]
    public int bindPipeline([NativeTypeName("gfx::IPipelineState *")] IPipelineState* state, IShaderObject** outRootObject)
    {
        return Marshal.GetDelegateForFunctionPointer<_bindPipeline>(lpVtbl->bindPipeline)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), state, outRootObject);
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_bindPipelineWithRootObject>(lpVtbl->bindPipelineWithRootObject)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), state, rootObject);
    }

    /// <include file='IRayTracingCommandEncoder.xml' path='doc/member[@name="IRayTracingCommandEncoder.dispatchRays"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("gfx::Result")]
    public int dispatchRays([NativeTypeName("gfx::GfxIndex")] int rayGenShaderIndex, [NativeTypeName("gfx::IShaderTable *")] IShaderTable* shaderTable, [NativeTypeName("gfx::GfxCount")] int width, [NativeTypeName("gfx::GfxCount")] int height, [NativeTypeName("gfx::GfxCount")] int depth)
    {
        return Marshal.GetDelegateForFunctionPointer<_dispatchRays>(lpVtbl->dispatchRays)((IRayTracingCommandEncoder*)Unsafe.AsPointer(ref this), rayGenShaderIndex, shaderTable, width, height, depth);
    }
    ...
    public partial struct Vtbl
    {
        ...
        [NativeTypeName("void (IBufferResource *, Offset, IBufferResource *, Offset, Size) __attribute__((stdcall))")]
        public IntPtr copyBuffer;

        [NativeTypeName("void (ITextureResource *, ResourceState, SubresourceRange, ITextureResource::Offset3D, ITextureResource *, ResourceState, SubresourceRange, ITextureResource::Offset3D, ITextureResource::Extents) __attribute__((stdcall))")]
        public IntPtr copyTexture;

        [NativeTypeName("void (IBufferResource *, Offset, Size, Size, ITextureResource *, ResourceState, SubresourceRange, ITextureResource::Offset3D, ITextureResource::Extents) __attribute__((stdcall))")]
        public IntPtr copyTextureToBuffer;

        [NativeTypeName("void (ITextureResource *, SubresourceRange, ITextureResource::Offset3D, ITextureResource::Extents, ITextureResource::SubresourceData *, GfxCount) __attribute__((stdcall))")]
        ...
        [NativeTypeName("void (GfxCount, ITextureResource *const *, ResourceState, ResourceState) __attribute__((stdcall))")]
        public IntPtr textureBarrier;

        [NativeTypeName("void (ITextureResource *, SubresourceRange, ResourceState, ResourceState) __attribute__((stdcall))")]
        public IntPtr textureSubresourceBarrier;

        [NativeTypeName("void (GfxCount, IBufferResource *const *, ResourceState, ResourceState) __attribute__((stdcall))")]
        public IntPtr bufferBarrier;

        [NativeTypeName("void (IResourceView *, ClearValue *, ClearResourceViewFlags::Enum) __attribute__((stdcall))")]
        public IntPtr clearResourceView;

        [NativeTypeName("void (ITextureResource *, ResourceState, SubresourceRange, ITextureResource *, ResourceState, SubresourceRange) __attribute__((stdcall))")]
        public IntPtr resolveResource;

        [NativeTypeName("void (IQueryPool *, GfxIndex, GfxCount, IBufferResource *, Offset) __attribute__((stdcall))")]
        ...
        [NativeTypeName("void (const IAccelerationStructure::BuildDesc &, GfxCount, AccelerationStructureQueryDesc *) __attribute__((stdcall))")]
        public IntPtr buildAccelerationStructure;

        [NativeTypeName("void (IAccelerationStructure *, IAccelerationStructure *, AccelerationStructureCopyMode) __attribute__((stdcall))")]
        public IntPtr copyAccelerationStructure;

        [NativeTypeName("void (GfxCount, IAccelerationStructure *const *, GfxCount, AccelerationStructureQueryDesc *) __attribute__((stdcall))")]
        ...
        [NativeTypeName("Result (GfxIndex, IShaderTable *, GfxCount, GfxCount, GfxCount) __attribute__((stdcall))")]
