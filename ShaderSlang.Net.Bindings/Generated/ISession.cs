...
public unsafe partial struct ISession
{
    ...
    public delegate IModule* _loadModule(
        ISession* pThis,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("slang::IModule *")]
    public delegate IModule* _loadModuleFromSource(
        ISession* pThis,
        [NativeTypeName("const char *")] sbyte* moduleName,
        [NativeTypeName("const char *")] sbyte* path,
        [NativeTypeName("slang::IBlob *")] ISlangBlob* source,
        [NativeTypeName("slang::IBlob **")] ISlangBlob** outDiagnostics = null
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _createCompositeComponentType(
        ISession* pThis,
        [NativeTypeName("IComponentType *const *")] IComponentType** componentTypes,
        [NativeTypeName("SlangInt")] nint componentTypeCount,
    ...
    public delegate TypeReflection* _specializeType(
        ISession* pThis,
    ...
    public delegate TypeLayoutReflection* _getTypeLayout(
        ISession* pThis,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* type,
        [NativeTypeName("SlangInt")] nint targetIndex = 0,
        [NativeTypeName("slang::LayoutRules")] LayoutRules rules = LayoutRules.Default,
        ISlangBlob** outDiagnostics = null
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("slang::TypeReflection *")]
    public delegate TypeReflection* _getContainerType(
        ISession* pThis,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* elementType,
        [NativeTypeName("slang::ContainerType")] ContainerType containerType,
        ISlangBlob** outDiagnostics = null
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _getTypeRTTIMangledName(
        ISession* pThis,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* type,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _getTypeConformanceWitnessMangledName(
        ISession* pThis,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* type,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* interfaceType,
        ISlangBlob** outNameBlob
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _getTypeConformanceWitnessSequentialID(
        ISession* pThis,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* type,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* interfaceType,
        [NativeTypeName("uint32_t *")] uint* outId
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _createTypeConformanceComponentType(
        ISession* pThis,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* type,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* interfaceType,
        ITypeConformance** outConformance,
        [NativeTypeName("SlangInt")] nint conformanceIdOverride,
        ISlangBlob** outDiagnostics
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("slang::IModule *")]
    public delegate IModule* _loadModuleFromIRBlob(
        ISession* pThis,
        [NativeTypeName("const char *")] sbyte* moduleName,
        [NativeTypeName("const char *")] sbyte* path,
        [NativeTypeName("slang::IBlob *")] ISlangBlob* source,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("slang::IModule *")]
    public delegate IModule* _getLoadedModule(
        ISession* pThis,
    ...
    public delegate Boolean _isBinaryModuleUpToDate(
        ISession* pThis,
        [NativeTypeName("const char *")] sbyte* modulePath,
        [NativeTypeName("slang::IBlob *")] ISlangBlob* binaryModuleBlob
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("slang::IModule *")]
    public delegate IModule* _loadModuleFromSourceString(
        ISession* pThis,
        [NativeTypeName("const char *")] sbyte* moduleName,
        [NativeTypeName("const char *")] sbyte* path,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _getDynamicObjectRTTIBytes(
        ISession* pThis,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* type,
        [NativeTypeName("slang::TypeReflection *")] TypeReflection* interfaceType,
        [NativeTypeName("uint32_t *")] uint* outRTTIDataBuffer,
        [NativeTypeName("uint32_t")] uint bufferSizeInBytes
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _loadModuleInfoFromIRBlob(
        ISession* pThis,
        [NativeTypeName("slang::IBlob *")] ISlangBlob* source,
    ...
    )
    {
        return Marshal.GetDelegateForFunctionPointer<_queryInterface>(lpVtbl->queryInterface)(
            (ISession*)Unsafe.AsPointer(ref this),
            uuid,
            outObject
        );
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getGlobalSession>(lpVtbl->getGlobalSession)(
            (ISession*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("slang::IModule *")]
    public IModule* loadModule(
        [NativeTypeName("const char *")] sbyte* moduleName,
        [NativeTypeName("IBlob **")] ISlangBlob** outDiagnostics = null
    )
    {
        return Marshal.GetDelegateForFunctionPointer<_loadModule>(lpVtbl->loadModule)(
            (ISession*)Unsafe.AsPointer(ref this),
            moduleName,
            outDiagnostics
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("slang::IModule *")]
    public IModule* loadModuleFromSource(
        [NativeTypeName("const char *")] sbyte* moduleName,
        [NativeTypeName("const char *")] sbyte* path,
        [NativeTypeName("slang::IBlob *")] ISlangBlob* source,
        [NativeTypeName("slang::IBlob **")] ISlangBlob** outDiagnostics = null
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_loadModuleFromSource>(
            lpVtbl->loadModuleFromSource
        )((ISession*)Unsafe.AsPointer(ref this), moduleName, path, source, outDiagnostics);
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_createCompositeComponentType>(
            lpVtbl->createCompositeComponentType
        )(
            (ISession*)Unsafe.AsPointer(ref this),
            componentTypes,
            componentTypeCount,
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_specializeType>(lpVtbl->specializeType)(
            (ISession*)Unsafe.AsPointer(ref this),
            type,
            specializationArgs,
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getTypeLayout>(lpVtbl->getTypeLayout)(
            (ISession*)Unsafe.AsPointer(ref this),
            type,
            targetIndex,
            rules,
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getDynamicType>(lpVtbl->getDynamicType)(
            (ISession*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getTypeRTTIMangledName>(
            lpVtbl->getTypeRTTIMangledName
        )((ISession*)Unsafe.AsPointer(ref this), type, outNameBlob);
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getTypeConformanceWitnessMangledName>(
            lpVtbl->getTypeConformanceWitnessMangledName
        )((ISession*)Unsafe.AsPointer(ref this), type, interfaceType, outNameBlob);
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getTypeConformanceWitnessSequentialID>(
            lpVtbl->getTypeConformanceWitnessSequentialID
        )((ISession*)Unsafe.AsPointer(ref this), type, interfaceType, outId);
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_createTypeConformanceComponentType>(
            lpVtbl->createTypeConformanceComponentType
        )(
            (ISession*)Unsafe.AsPointer(ref this),
            type,
            interfaceType,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("slang::IModule *")]
    public IModule* loadModuleFromIRBlob(
        [NativeTypeName("const char *")] sbyte* moduleName,
        [NativeTypeName("const char *")] sbyte* path,
        [NativeTypeName("slang::IBlob *")] ISlangBlob* source,
        [NativeTypeName("slang::IBlob **")] ISlangBlob** outDiagnostics = null
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_loadModuleFromIRBlob>(
            lpVtbl->loadModuleFromIRBlob
        )((ISession*)Unsafe.AsPointer(ref this), moduleName, path, source, outDiagnostics);
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getLoadedModuleCount>(
            lpVtbl->getLoadedModuleCount
        )((ISession*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getLoadedModule>(lpVtbl->getLoadedModule)(
            (ISession*)Unsafe.AsPointer(ref this),
            index
        );
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("bool")]
    public Boolean isBinaryModuleUpToDate(
        [NativeTypeName("const char *")] sbyte* modulePath,
        [NativeTypeName("slang::IBlob *")] ISlangBlob* binaryModuleBlob
    )
    {
        return Marshal.GetDelegateForFunctionPointer<_isBinaryModuleUpToDate>(
            lpVtbl->isBinaryModuleUpToDate
        )((ISession*)Unsafe.AsPointer(ref this), modulePath, binaryModuleBlob);
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_loadModuleFromSourceString>(
            lpVtbl->loadModuleFromSourceString
        )((ISession*)Unsafe.AsPointer(ref this), moduleName, path, @string, outDiagnostics);
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getDynamicObjectRTTIBytes>(
            lpVtbl->getDynamicObjectRTTIBytes
        )(
            (ISession*)Unsafe.AsPointer(ref this),
            type,
            interfaceType,
    ...
    /// <include file='ISession.xml' path='doc/member[@name="ISession.loadModuleInfoFromIRBlob"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("SlangResult")]
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_loadModuleInfoFromIRBlob>(
            lpVtbl->loadModuleInfoFromIRBlob
        )(
            (ISession*)Unsafe.AsPointer(ref this),
            source,
            outModuleVersion,
