...
public unsafe partial struct IByteCodeRunner
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _loadModule(
        IByteCodeRunner* pThis,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _selectFunctionByIndex(
        IByteCodeRunner* pThis,
        [NativeTypeName("uint32_t")] uint functionIndex
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate int _findFunctionByName(
        IByteCodeRunner* pThis,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _getFunctionInfo(
        IByteCodeRunner* pThis,
        [NativeTypeName("uint32_t")] uint index,
        [NativeTypeName("slang::ByteCodeFuncInfo *")] ByteCodeFuncInfo* outInfo
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _execute(
        IByteCodeRunner* pThis,
        void* argumentData,
        [NativeTypeName("size_t")] nuint argumentSize
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void _getErrorString(
        IByteCodeRunner* pThis,
        [NativeTypeName("IBlob **")] ISlangBlob** outBlob
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void* _getReturnValue(
        IByteCodeRunner* pThis,
        [NativeTypeName("size_t *")] nuint* outValueSize
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _registerExtCall(
        IByteCodeRunner* pThis,
        [NativeTypeName("const char *")] sbyte* name,
        [NativeTypeName("slang::VMExtFunction")] IntPtr functionPtr
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("SlangResult")]
    public delegate int _setPrintCallback(
        IByteCodeRunner* pThis,
        [NativeTypeName("slang::VMPrintFunc")] IntPtr callback,
        void* userData
    );
    ...
    )
    {
        return Marshal.GetDelegateForFunctionPointer<_queryInterface>(lpVtbl->queryInterface)(
            (IByteCodeRunner*)Unsafe.AsPointer(ref this),
            uuid,
            outObject
        );
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_selectFunctionByIndex>(
            lpVtbl->selectFunctionByIndex
        )((IByteCodeRunner*)Unsafe.AsPointer(ref this), functionIndex);
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_findFunctionByName>(
            lpVtbl->findFunctionByName
        )((IByteCodeRunner*)Unsafe.AsPointer(ref this), name);
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getFunctionInfo>(lpVtbl->getFunctionInfo)(
            (IByteCodeRunner*)Unsafe.AsPointer(ref this),
            index,
            outInfo
        );
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getCurrentWorkingSet>(
            lpVtbl->getCurrentWorkingSet
        )((IByteCodeRunner*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_execute>(lpVtbl->execute)(
            (IByteCodeRunner*)Unsafe.AsPointer(ref this),
            argumentData,
            argumentSize
        );
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_getErrorString>(lpVtbl->getErrorString)(
            (IByteCodeRunner*)Unsafe.AsPointer(ref this),
            outBlob
        );
    }
    ...
    {
        return Marshal.GetDelegateForFunctionPointer<_getReturnValue>(lpVtbl->getReturnValue)(
            (IByteCodeRunner*)Unsafe.AsPointer(ref this),
            outValueSize
        );
    }
    ...
    {
        Marshal.GetDelegateForFunctionPointer<_setExtInstHandlerUserData>(
            lpVtbl->setExtInstHandlerUserData
        )((IByteCodeRunner*)Unsafe.AsPointer(ref this), userData);
    }

    /// <include file='IByteCodeRunner.xml' path='doc/member[@name="IByteCodeRunner.registerExtCall"]/*' />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("SlangResult")]
    public int registerExtCall(
        [NativeTypeName("const char *")] sbyte* name,
        [NativeTypeName("slang::VMExtFunction")] IntPtr functionPtr
    )
    {
        return Marshal.GetDelegateForFunctionPointer<_registerExtCall>(lpVtbl->registerExtCall)(
            (IByteCodeRunner*)Unsafe.AsPointer(ref this),
            name,
            functionPtr
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NativeTypeName("SlangResult")]
    public int setPrintCallback(
        [NativeTypeName("slang::VMPrintFunc")] IntPtr callback,
        void* userData
    )
    {
        return Marshal.GetDelegateForFunctionPointer<_setPrintCallback>(lpVtbl->setPrintCallback)(
            (IByteCodeRunner*)Unsafe.AsPointer(ref this),
            callback,
            userData
        );
