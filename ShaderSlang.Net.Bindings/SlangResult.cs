...
namespace ShaderSlang.Net.Bindings;
...
public readonly record struct SlangResult(int RawValue)
{
    ...
    public override string ToString()
    {
        ...
        else if (this == BufferTooSmall)
            return nameof(BufferTooSmall);
        else if (this == OutOfMemory)
            return nameof(OutOfMemory);
        else if (this == Uninitialized)
            return nameof(Uninitialized);
        else if (this == Pending)
            return nameof(Pending);
        else if (this == CannotOpen)
            return nameof(CannotOpen);
        else if (this == NotFound)
            return nameof(NotFound);
        else if (this == InternalFail)
            return nameof(InternalFail);
        else if (this == NotAvailable)
            return nameof(NotAvailable);
        else if (this == TimeOut)
            return nameof(TimeOut);
        else if (this == InsufficientBuffer)
            return nameof(InsufficientBuffer);
        else if (this == InvalidHandle)
            return nameof(InvalidHandle);
        else if (this == InvalidArg)
            return nameof(InvalidArg);
        else if (this == InvalidParameter)
            return nameof(InvalidParameter);
    ...
    public void ThrowIfFailed(string? diagnostics = null)
    {
        ...
        if (this == CannotOpen)
            throw new IOException(message, RawValue);
        if (this == NotFound)
...
public sealed class SlangException : Exception
{
    ...
    public SlangException()
        : this(SlangResult.Fail) { }

    public SlangException(SlangResult result)
        : this(result.ToString(), result) { }

    internal SlangException(string message, SlangResult result)
        : base(message)
    {
