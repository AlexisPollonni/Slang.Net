...
static class CodeWriterExtensions
{
    ...
    {
        public InvokeBuilder BuildMethodInvoke(IMethodSymbol method) => new(writer, method);

        public ICodeWriter WriteVariableDeclaration(string type, string name, string? value = null)
        {
        ...
        public ICodeWriter WriteVariableDeclaration(
            ITypeSymbol type,
            string name,
            string? value = null
        )
