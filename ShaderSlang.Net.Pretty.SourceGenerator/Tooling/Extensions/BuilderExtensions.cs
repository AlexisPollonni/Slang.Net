...
{
    extension(MethodBuilder methodBuilder)
    {
        public MethodBuilder AddGenericsFrom(IMethodSymbol originMethod)
        {
        ...
        public MethodBuilder WithReturnType(ITypeSymbol returnType)
        {
            return methodBuilder.WithReturnType(returnType.ToFullyQualified());
        }

        public MethodBuilder AddAggressiveInliningAttribute()
        {
        ...
        public MethodBuilder AddGeneratedCodeAttribute<TGenerator>(Version version)
    ...
    extension(ClassBuilder classBuilder)
    {
        public ClassBuilder AddGeneratedCodeAttribute<TGenerator>(Version version)
            where TGenerator : IncrementalGenerator
        {
