...
public readonly unsafe partial struct TypeLayoutReflection
    : IEquatable<TypeLayoutReflection>,
        INativeHandleMarshallable<TypeLayoutReflection>
{
    ...
    internal TypeLayoutReflection(Unmanaged.SlangReflectionTypeLayout* pointer)
    {
        ...
        Categories = new NativeBoundedReadOnlyList<TypeLayoutReflection, ParameterCategory>
        {
            ...
            TryGetAt = (layout, index) =>
                ReflectionTypeLayout_GetCategoryByIndex(layout, checked((uint)index)),
        };
    ...
    public TypeReflection Type =>
        ...
        ?? throw new SlangException(
            $"{nameof(ReflectionTypeLayout_GetType)} returned a null pointer"
        );
    ...
    public VariableLayoutReflection? ExplicitCounter =>
        ReflectionTypeLayout_GetExplicitCounter(this);
    ...
    public TypeLayoutReflection? ElementTypeLayout =>
        ReflectionTypeLayout_GetElementTypeLayout(this);

    public VariableLayoutReflection? ElementVarLayout =>
        ReflectionTypeLayout_GetElementVarLayout(this);

    public VariableLayoutReflection? ContainerVarLayout =>
        ReflectionTypeLayout_getContainerVarLayout(this);

    public ParameterCategory ParameterCategory => ReflectionTypeLayout_GetParameterCategory(this);
    ...
    public int GenericParamIndex => ReflectionTypeLayout_getGenericParamIndex(this);

    public TypeLayoutReflection? PendingDataTypeLayout =>
        ReflectionTypeLayout_getPendingDataTypeLayout(this);

    public VariableLayoutReflection? SpecializedTypePendingDataVarLayout =>
        ReflectionTypeLayout_getSpecializedTypePendingDataVarLayout(this);
