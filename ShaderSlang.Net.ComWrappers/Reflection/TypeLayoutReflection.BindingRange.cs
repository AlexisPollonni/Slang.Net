...
partial struct TypeLayoutReflection
{
    public readonly struct BindingRange : IEquatable<BindingRange>
    {
        ...
        public BindingType BindingRangeType =>
            ReflectionTypeLayout_getBindingRangeType(TypeLayout, (nint)Index);
        public long BindingCount =>
            ReflectionTypeLayout_getBindingRangeBindingCount(TypeLayout, (nint)Index);
        public TypeLayoutReflection? LeafTypeLayout =>
            ReflectionTypeLayout_getBindingRangeLeafTypeLayout(TypeLayout, (nint)Index);
        public VariableReflection? LeafVariable =>
            ReflectionTypeLayout_getBindingRangeLeafVariable(TypeLayout, (nint)Index);
        public long DescriptorSetIndex =>
            ReflectionTypeLayout_getBindingRangeDescriptorSetIndex(TypeLayout, (nint)Index);
        public long FirstDescriptorRangeIndex =>
            ReflectionTypeLayout_getBindingRangeFirstDescriptorRangeIndex(TypeLayout, (nint)Index);
        public long DescriptorRangeCount =>
            ReflectionTypeLayout_getBindingRangeDescriptorRangeCount(TypeLayout, (nint)Index);
    }
}
