...
public readonly unsafe struct VariableReflection
    : IEquatable<VariableReflection>,
        INativeHandleMarshallable<VariableReflection>
{
    ...
    internal VariableReflection(Unmanaged.SlangReflectionVariable* pointer)
    {
        ...
        UserAttributes = new NativeBoundedReadOnlyList<VariableReflection, UserAttribute>
        {
            ...
            TryGetAt = (@this, index) =>
                ReflectionApi.ReflectionVariable_GetUserAttribute(@this, checked((uint)index)),
        };
    }
    ...
    public TypeReflection Type =>
        ReflectionApi.ReflectionVariable_GetType(this)
        ?? throw new SlangException(
            $"{nameof(ReflectionApi.ReflectionVariable_GetType)} returned a null pointer"
        );
    ...
    public long? DefaultValueInt =>
        ReflectionApi.ReflectionVariable_GetDefaultValueInt(this, out var res) ? res : null;

    public GenericReflection? GenericContainer =>
        ReflectionApi.ReflectionVariable_GetGenericContainer(this);
