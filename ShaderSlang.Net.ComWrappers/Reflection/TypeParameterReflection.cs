...
public readonly unsafe struct TypeParameterReflection
    : IEquatable<TypeParameterReflection>,
        INativeHandleMarshallable<TypeParameterReflection>
{
    ...
    internal TypeParameterReflection(Unmanaged.SlangReflectionTypeParameter* handle)
    {
        ...
        Constraints = new NativeBoundedReadOnlyList<TypeParameterReflection, TypeReflection>
        {
            Container = this,
            GetCount = @this =>
                checked((nint)ReflectionApi.ReflectionTypeParameter_GetConstraintCount(@this)),
            TryGetAt = (@this, index) =>
                ReflectionApi.ReflectionTypeParameter_GetConstraintByIndex(
                    @this,
                    checked((uint)index)
                ),
        };
    ...
    public override bool Equals(object? obj) =>
        obj is TypeParameterReflection other && Equals(other);
