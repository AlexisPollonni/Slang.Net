...
[NativeMarshalling(typeof(MarshalableMarshaller.Bidirectional<SlangDescription, Unmanaged.IDevice.SlangDesc>))]
...
{
    unsafe Unmanaged.IDevice.SlangDesc IMarshalsToNative<Unmanaged.IDevice.SlangDesc>.
        AsNative(ref GrowingStackBuffer buffer) =>
        new()
        {
            slangGlobalSession = GlobalSession.InterfaceToPtr<IGlobalSession, Unmanaged.IGlobalSession>(),
            ...
            preprocessorMacros
                = buffer.GetCollectionPtr<PreprocessorMacroDescription, Unmanaged.PreprocessorMacroDesc>(
                    PreprocessorMacros,
                    out var macroCount),
    ...
    public static unsafe SlangDescription CreateFromNative(Unmanaged.IDevice.SlangDesc unmanaged) =>
        new(ComInterfaceMarshaller<IGlobalSession>.ConvertToManaged(unmanaged.slangGlobalSession),
            ...
            InteropUtils.PtrToManagedMarshal<PreprocessorMacroDescription, Unmanaged.PreprocessorMacroDesc>(
                ...
                unmanaged.preprocessorMacroCount),
