...
[NativeMarshalling(typeof(MarshalableMarshaller.Bidirectional<SamplerStateDescription, Unmanaged.ISamplerState.SamplerStateDesc>))]
public readonly record struct SamplerStateDescription(Unmanaged.TextureFilteringMode MinFilter = Unmanaged.TextureFilteringMode.Linear,
      ...
      IMarshalsFromNative<SamplerStateDescription, Unmanaged.ISamplerState.SamplerStateDesc> 
{
    ...
    public static SamplerStateDescription CreateFromNative(Unmanaged.ISamplerState.SamplerStateDesc unmanaged)
    {
        var borderColor = Color.FromArgb((int)(unmanaged.borderColor[3] * byte.MaxValue),
        ...
        return new(unmanaged.minFilter,
                   unmanaged.magFilter,
                   unmanaged.mipFilter,
