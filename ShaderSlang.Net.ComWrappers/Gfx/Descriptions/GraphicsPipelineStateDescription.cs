...
{
    unsafe Unmanaged.GraphicsPipelineStateDesc IMarshalsToNative<Unmanaged.GraphicsPipelineStateDesc>.AsNative(
    ...
    public static unsafe GraphicsPipelineStateDescription CreateFromNative(
        Unmanaged.GraphicsPipelineStateDesc unmanaged
    ) =>
        new(
