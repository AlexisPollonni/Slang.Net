...
[NativeMarshalling(typeof(MarshalableMarshaller.Bidirectional<ResourceDescriptionBase, Unmanaged.IResource.DescBase>))]
public readonly record struct ResourceDescriptionBase(
    ...
    bool IsShared = false
) : IMarshalsToNative<Unmanaged.IResource.DescBase>, IMarshalsFromNative<ResourceDescriptionBase, Unmanaged.IResource.DescBase>
{
    Unmanaged.IResource.DescBase IMarshalsToNative<Unmanaged.IResource.DescBase>.AsNative(ref GrowingStackBuffer buffer) =>
        new()
        {
            type = Type,
    ...
    public static ResourceDescriptionBase CreateFromNative(Unmanaged.IResource.DescBase unmanaged) =>
        new(
            unmanaged.type,
