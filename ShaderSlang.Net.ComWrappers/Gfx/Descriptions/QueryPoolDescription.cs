...
[NativeMarshalling(
    typeof(MarshalableMarshaller.Bidirectional<
        ...
        Unmanaged.IQueryPool.QueryPoolDesc
    >)
)]
...
{
    Unmanaged.IQueryPool.QueryPoolDesc IMarshalsToNative<Unmanaged.IQueryPool.QueryPoolDesc>.AsNative(
        ref GrowingStackBuffer buffer
    ) => new() { type = QueryType, count = QueryCount };

    public static QueryPoolDescription CreateFromNative(
        Unmanaged.IQueryPool.QueryPoolDesc unmanaged
