...
[NativeMarshalling(
    typeof(BidirectionalMarshaller<
        SampleDescription,
        Unmanaged.ITextureResource.SampleDesc
    >)
)]
        ...
        IMarshalsFromNative<SampleDescription, Unmanaged.ITextureResource.SampleDesc>
{
    ...
    ) => new() { numSamples = NumSamples, quality = Quality };

    public static SampleDescription CreateFromNative(
        Unmanaged.ITextureResource.SampleDesc unmanaged
