...
public partial interface IResourceCommandEncoder : ICommandEncoder
{
    ...
    void CopyBuffer(IBufferResource dst, nuint dstOffset, IBufferResource src, nuint srcOffset, nuint size);

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void CopyTexture(ITextureResource dst,
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void CopyTextureToBuffer(IBufferResource dst,
                             Unmanaged.ITextureResource.Offset3D dstOffset,
                             nuint dstSize,
                             nuint dstRowStride,
                             ITextureResource src,
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void UploadTextureData(ITextureResource dst,
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void UploadBufferData(IBufferResource dst, nuint offset, nuint size, 
                          [MarshalUsing(CountElementName = "size")]
                          Span<byte> data);

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void TextureBarrier(int count,
                        [MarshalUsing(CountElementName = "count")]
                        Span<ITextureResource> textures,
                        Unmanaged.ResourceState src,
                        Unmanaged.ResourceState dst);

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void TextureSubresourceBarrier(ITextureResource texture,
                                   Unmanaged.SubresourceRange subresourceRange,
                                   Unmanaged.ResourceState src,
                                   Unmanaged.ResourceState dst);
    
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void BufferBarrier(int count,
                       [MarshalUsing(CountElementName = "count")]
                       Span<IBufferResource> buffers, 
                       Unmanaged.ResourceState src,
                       Unmanaged.ResourceState dst);

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void ClearResourceView(IResourceView view, Unmanaged.ClearValue clearValue, Unmanaged.ClearResourceViewFlags flags);

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void ResolveResource(ITextureResource source,
                         Unmanaged.ResourceState srcState,
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void ResolveQuery(IQueryPool queryPool, int index, int count, IBufferResource buffer, nuint offset);
