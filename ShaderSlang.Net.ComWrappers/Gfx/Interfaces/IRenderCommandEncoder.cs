...
public partial interface IRenderCommandEncoder : IResourceCommandEncoder
{
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult SetViewports(
        int count,
        [MarshalUsing(CountElementName = "count")] Span<Unmanaged.Viewport> viewports
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    void SetScissorRects(
        int count,
        [MarshalUsing(CountElementName = "count")] Span<Unmanaged.ScissorRect> scissors
    );
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult DrawIndexedIndirect(
        int maxDrawCount,
        IBufferResource argBuffer,
        nuint argOffset,
        IBufferResource? countBuffer = null,
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult SetSamplePositions(
        int samplesPerPixel,
        int pixelCount,
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult DrawIndexedInstanced(
        int indexCount,
        int instanceCount,
