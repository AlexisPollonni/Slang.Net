...
public partial interface IDevice : IUnknown
{
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult GetFeatures(
        [MarshalUsing(CountElementName = "bufferSize")] Span<string> outFeatures,
        nuint bufferSize,
        out int outFeatureCount
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult GetFormatSupportedResourceStates(
        Unmanaged.Format format,
        out ResourceStateSet states
    );
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateTransientResourceHeap(
        TransientResourceHeapDescription desc,
        out ITransientResourceHeap heap
    );
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateTextureFromNativeHandle(
        Unmanaged.InteropHandle handle,
        TextureResourceDescription srcDesc,
        out ITextureResource resource
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateTextureFromSharedHandle(
        Unmanaged.InteropHandle handle,
        TextureResourceDescription srcDesc,
        nuint size,
        out ITextureResource resource
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateBufferResource(
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateBufferFromNativeHandle(
        Unmanaged.InteropHandle handle,
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateBufferFromSharedHandle(
        Unmanaged.InteropHandle handle,
        BufferResourceDescription srcDesc,
        out IBufferResource resource
    );
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateFramebufferLayout(
        FramebufferLayoutDescription desc,
        out IFramebufferLayout framebuffer
    );
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateRenderPassLayout(
        RenderPassLayoutDescription desc,
        out IRenderPassLayout renderPassLayout
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateSwapchain(
        SwapchainDescription desc,
        Unmanaged.WindowHandle window,
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateShaderObject(
        TypeReflection type,
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateMutableShaderObject(
        TypeReflection type,
        Unmanaged.ShaderObjectContainerType container,
        out IShaderObject shaderObject
    );
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateShaderObjectFromTypeLayout(
        TypeLayoutReflection typeLayout,
        out IShaderObject shaderObject
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateMutableShaderObjectFromTypeLayout(
        TypeLayoutReflection typeLayout,
        out IShaderObject shaderObject
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateMutableRootShaderObject(
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateProgram2(
        ShaderProgramCreateDescription2 desc,
        out IShaderProgram program,
        out IBlob? diagnostics
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateGraphicsPipelineState(
        GraphicsPipelineStateDescription desc,
        out IPipelineState pipelineState
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateComputePipelineState(
        ComputePipelineStateDescription desc,
        out IPipelineState pipelineState
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateRayTracingPipelineState(
        RayTracingPipelineStateDescription desc,
        out IPipelineState pipelineState
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult ReadTextureResource(
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult ReadBufferResource(
        IBufferResource buffer,
        nuint offset,
        nuint size,
        out IBlob blob
    ...
    SlangResult GetAccelerationStructurePrebuildInfo(
        ...
        out Unmanaged.IAccelerationStructure.PrebuildInfo prebuildInfo
    ); //TODO

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateAccelerationStructure(
        in Unmanaged.IAccelerationStructure.CreateDesc desc,
        out IAccelerationStructure view
    ); //TODO
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult GetTextureAllocationInfo(
        TextureResourceDescription desc,
        out nuint size,
        out nuint alignment
    );
    ...
    SlangResult GetCooperativeVectorProperties(
        [MarshalUsing(CountElementName = "propertyCount")]
            Span<Unmanaged.CooperativeVectorProperties> properties,
        ref uint propertyCount
    );

    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateShaderObject2(
    ...
    [PreserveSig, UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
    SlangResult CreateMutableShaderObject2(
        ISession slangSession,
        TypeReflection type,
        Unmanaged.ShaderObjectContainerType container,
        out IShaderObject shaderObject
