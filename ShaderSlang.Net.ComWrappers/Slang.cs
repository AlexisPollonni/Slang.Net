...
public static partial class Slang
{
    ...
    public static partial SlangResult CreateGlobalSession(
        int apiVersion,
        out IGlobalSession globalSession
    );

    [LibraryImport("slang", EntryPoint = "slang_createGlobalSession2")]
    public static partial SlangResult CreateGlobalSession(
        GlobalSessionDescription desc,
        out IGlobalSession globalSession
    );

    [LibraryImport("slang", EntryPoint = "slang_createGlobalSessionWithoutCoreModule")]
    public static partial SlangResult CreateGlobalSessionWithoutCoreModule(
        int apiVersion,
        out IGlobalSession globalSession
    );
    ...
    [LibraryImport(
        ...
        EntryPoint = "slang_getLastInternalErrorMessage"
    )]
    ...
    public static partial SlangResult CreateByteCodeRunner(
        in Unmanaged.ByteCodeRunnerDesc desc,
    ...
    public static partial SlangResult DisassembleByteCode(
        IBlob moduleBlob,
        out IBlob outDisassemblyBlob
    );

    [LibraryImport("slang", EntryPoint = "slang_createBlob")]
    public static partial IBlob? CreateBlob(
    ...
    public static partial IModule? LoadModuleFromSource(
        ISession session,
        string moduleName,
        string path,
        [MarshalUsing(CountElementName = "sourceSize")] string source,
        nuint sourceSize,
    ...
    public static partial IModule? LoadModuleFromIRBlob(
        ISession session,
        string moduleName,
        string path,
        [MarshalUsing(CountElementName = "sourceSize")] ReadOnlySpan<byte> source,
        nuint sourceSize,
        out IBlob? diagnostics
    );
    ...
    public static partial SlangResult LoadModuleInfoFromIRBlob(
        ISession session,
        [MarshalUsing(CountElementName = "sourceSize")] ReadOnlySpan<byte> source,
        nuint sourceSize,
    ...
    {
        CreateGlobalSession(
                new GlobalSessionDescription(Unmanaged.SlangApi.SLANG_API_VERSION),
                out var globalSession
            )
            .ThrowIfFailed();
