...
public readonly unsafe struct EntryPointReflection : IEquatable<EntryPointReflection>, INativeHandleMarshallable<EntryPointReflection>
{
    ...
    internal EntryPointReflection(Unmanaged.SlangEntryPointLayout* pointer)
    {
        ...
        {
            Container = this,
            GetCount = container => (nint)ReflectionApi.ReflectionEntryPoint_getParameterCount(container),
            TryGetAt = (@this, index) => ReflectionApi.ReflectionEntryPoint_getParameterByIndex(@this, checked((uint)index))
        };
    }
    ...
    public nuint[] ComputeThreadGroupSize
    {
        get
        {
            ...
            ReflectionApi.ReflectionEntryPoint_getComputeThreadGroupSize(this, MaxComputeAxes, axes);
    ...
    public bool UsesAnySampleRateInput => ReflectionApi.ReflectionEntryPoint_usesAnySampleRateInput(this) != 0;

    public VariableLayoutReflection? VarLayout => ReflectionApi.ReflectionEntryPoint_getVarLayout(this);
    public TypeLayoutReflection? TypeLayout => VarLayout?.TypeLayout;
    public VariableLayoutReflection? ResultVarLayout => ReflectionApi.ReflectionEntryPoint_getResultVarLayout(this);
    public bool HasDefaultConstantBuffer => ReflectionApi.ReflectionEntryPoint_hasDefaultConstantBuffer(this) != 0; 
}
