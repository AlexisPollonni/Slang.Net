...
public readonly unsafe struct TypeReflection : IEquatable<TypeReflection>, INativeHandleMarshallable<TypeReflection>
{
    ...
    internal TypeReflection(Unmanaged.SlangReflectionType* pointer) 
    {
        ...
        UserAttributes = new NativeBoundedReadOnlyList<TypeReflection, UserAttribute>
        {
            ...
            TryGetAt = (@this, index) => ReflectionApi.ReflectionType_GetUserAttribute(@this, checked((uint)index))
        };
        Fields = new NativeBoundedReadOnlyList<TypeReflection, VariableReflection>
        {
            ...
            TryGetAt = (@this, index) => ReflectionApi.ReflectionType_GetFieldByIndex(@this, checked((uint)index))
        };
        ...
        {
            Container = this,
            GetCount = @this => checked((nint)ReflectionApi.ReflectionType_getSpecializedTypeArgCount(@this)),
            TryGetAt = (@this, index) => ReflectionApi.ReflectionType_getSpecializedTypeArgType(@this, index)
        };
    }
    ...
    public ulong TotalArrayElementCount
    {
        get
        {
            ...
            for (;;)
            {
                if (!type?.IsArray ?? true) return result;
    ...
    public TypeReflection? ResourceResultType => ReflectionApi.ReflectionType_GetResourceResultType(this);
    public Unmanaged.ResourceShape ResourceShape => ReflectionApi.ReflectionType_GetResourceShape(this);
    public Unmanaged.ResourceAccess ResourceAccess => ReflectionApi.ReflectionType_GetResourceAccess(this);
    ...
    public GenericReflection? GenericContainer => ReflectionApi.ReflectionType_GetGenericContainer(this);
