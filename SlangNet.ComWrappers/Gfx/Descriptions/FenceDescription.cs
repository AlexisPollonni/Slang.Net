...
[NativeMarshalling(typeof(MarshalableMarshaller.Bidirectional<FenceDescription, Unmanaged.IFence.FenceDesc>))]
...
{
    Unmanaged.IFence.FenceDesc IMarshalsToNative<Unmanaged.IFence.FenceDesc>.AsNative(ref GrowingStackBuffer buffer) =>
