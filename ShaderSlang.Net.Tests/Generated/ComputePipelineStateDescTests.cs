...
public static unsafe partial class ComputePipelineStateDescTests
{
    ...
    {
        Assert.Equal(sizeof(ComputePipelineStateDesc), Marshal.SizeOf<ComputePipelineStateDesc>());
    }
    ...
    {
        Assert.True(typeof(ComputePipelineStateDesc).IsLayoutSequential);
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.Equal(16, sizeof(ComputePipelineStateDesc));
        }
        else
        {
            Assert.Equal(8, sizeof(ComputePipelineStateDesc));
        }
    }
}
