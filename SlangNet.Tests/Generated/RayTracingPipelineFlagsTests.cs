...
public static unsafe partial class RayTracingPipelineFlagsTests
{
    ...
    {
        Assert.Equal(sizeof(RayTracingPipelineFlags), Marshal.SizeOf<RayTracingPipelineFlags>());
    }
    ...
    {
        Assert.True(typeof(RayTracingPipelineFlags).IsLayoutSequential);
    }
    ...
    {
        Assert.Equal(1, sizeof(RayTracingPipelineFlags));
    }
}
