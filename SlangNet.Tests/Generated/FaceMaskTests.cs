...
public static unsafe partial class FaceMaskTests
{
    ...
    {
        Assert.That(Marshal.SizeOf<FaceMask>(), Is.EqualTo(sizeof(FaceMask)));
    }
    ...
    {
        Assert.That(typeof(FaceMask).IsLayoutSequential, Is.True);
    }
    ...
    {
        Assert.That(sizeof(FaceMask), Is.EqualTo(1));
    }
}
