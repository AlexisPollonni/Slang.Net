...
using SlangNet.Pretty.SourceGenerator.MarshallingGenerator.Mappings;
...
class MarshallingCodeGenerator()
{
    ...
    private void WriteUsings()
    {
        ...
        _builder.AppendLine("using SlangNet.Bindings.Generated;");
        _builder.AppendLine("using SlangNet.Internal;");
        _builder.AppendLine();
